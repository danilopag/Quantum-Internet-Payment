...
<head>
  ...
  <title>netsquid.examples &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.examples.teleportation" href="api_examples/netsquid.examples.teleportation.html" />
    <link rel="prev" title="netsquid.util.constrainedmap" href="api_util/netsquid.util.constrainedmap.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">netsquid.examples</a><ul>
...
<li class="toctree-l1"><a class="reference internal" href="CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.examples</li>
      <li class="wy-breadcrumbs-aside">
            <a href="_sources/netsquid.examples.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="api_util/netsquid.util.constrainedmap.html" class="btn btn-neutral float-left" title="netsquid.util.constrainedmap" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="api_examples/netsquid.examples.teleportation.html" class="btn btn-neutral float-right" title="netsquid.examples.teleportation" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="netsquid-examples">
<h1>netsquid.examples<a class="headerlink" href="#netsquid-examples" title="Link to this heading"></a></h1>
<p>Modules containing complete examples for how to use NetSquid.</p>
<div class="toctree-wrapper compound">
<p class="caption" role="heading"><span class="caption-text">Modules</span></p>
<ul>
<li class="toctree-l1"><a class="reference internal" href="api_examples/netsquid.examples.teleportation.html">netsquid.examples.teleportation</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.teleportation.html#netsquid.examples.teleportation.EntanglingConnection"><code class="docutils literal notranslate"><span class="pre">EntanglingConnection</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.teleportation.html#netsquid.examples.teleportation.ClassicalConnection"><code class="docutils literal notranslate"><span class="pre">ClassicalConnection</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.teleportation.html#netsquid.examples.teleportation.InitStateProgram"><code class="docutils literal notranslate"><span class="pre">InitStateProgram</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.teleportation.html#netsquid.examples.teleportation.BellMeasurementProgram"><code class="docutils literal notranslate"><span class="pre">BellMeasurementProgram</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.teleportation.html#netsquid.examples.teleportation.BellMeasurementProtocol"><code class="docutils literal notranslate"><span class="pre">BellMeasurementProtocol</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.teleportation.html#netsquid.examples.teleportation.CorrectionProtocol"><code class="docutils literal notranslate"><span class="pre">CorrectionProtocol</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.teleportation.html#netsquid.examples.teleportation.create_processor"><code class="docutils literal notranslate"><span class="pre">create_processor()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.teleportation.html#netsquid.examples.teleportation.example_network_setup"><code class="docutils literal notranslate"><span class="pre">example_network_setup()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.teleportation.html#netsquid.examples.teleportation.example_sim_setup"><code class="docutils literal notranslate"><span class="pre">example_sim_setup()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.teleportation.html#netsquid.examples.teleportation.run_experiment"><code class="docutils literal notranslate"><span class="pre">run_experiment()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.teleportation.html#netsquid.examples.teleportation.create_plot"><code class="docutils literal notranslate"><span class="pre">create_plot()</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_examples/netsquid.examples.entanglenodes.html">netsquid.examples.entanglenodes</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.entanglenodes.html#netsquid.examples.entanglenodes.EntangleNodes"><code class="docutils literal notranslate"><span class="pre">EntangleNodes</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.entanglenodes.html#netsquid.examples.entanglenodes.example_network_setup"><code class="docutils literal notranslate"><span class="pre">example_network_setup()</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_examples/netsquid.examples.purify.html">netsquid.examples.purify</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.purify.html#netsquid.examples.purify.Filter"><code class="docutils literal notranslate"><span class="pre">Filter</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.purify.html#netsquid.examples.purify.Distil"><code class="docutils literal notranslate"><span class="pre">Distil</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.purify.html#netsquid.examples.purify.FilteringExample"><code class="docutils literal notranslate"><span class="pre">FilteringExample</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.purify.html#netsquid.examples.purify.example_network_setup"><code class="docutils literal notranslate"><span class="pre">example_network_setup()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.purify.html#netsquid.examples.purify.example_sim_setup"><code class="docutils literal notranslate"><span class="pre">example_sim_setup()</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_examples/netsquid.examples.repeater.html">netsquid.examples.repeater</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater.html#netsquid.examples.repeater.Repeater"><code class="docutils literal notranslate"><span class="pre">Repeater</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater.html#netsquid.examples.repeater.RepeaterExample"><code class="docutils literal notranslate"><span class="pre">RepeaterExample</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater.html#netsquid.examples.repeater.example_network_setup"><code class="docutils literal notranslate"><span class="pre">example_network_setup()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater.html#netsquid.examples.repeater.example_sim_setup"><code class="docutils literal notranslate"><span class="pre">example_sim_setup()</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_examples/netsquid.examples.repeater_chain.html">netsquid.examples.repeater_chain</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater_chain.html#netsquid.examples.repeater_chain.SwapProtocol"><code class="docutils literal notranslate"><span class="pre">SwapProtocol</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater_chain.html#netsquid.examples.repeater_chain.SwapCorrectProgram"><code class="docutils literal notranslate"><span class="pre">SwapCorrectProgram</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater_chain.html#netsquid.examples.repeater_chain.CorrectProtocol"><code class="docutils literal notranslate"><span class="pre">CorrectProtocol</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater_chain.html#netsquid.examples.repeater_chain.FibreDepolarizeModel"><code class="docutils literal notranslate"><span class="pre">FibreDepolarizeModel</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater_chain.html#netsquid.examples.repeater_chain.create_qprocessor"><code class="docutils literal notranslate"><span class="pre">create_qprocessor()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater_chain.html#netsquid.examples.repeater_chain.setup_network"><code class="docutils literal notranslate"><span class="pre">setup_network()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater_chain.html#netsquid.examples.repeater_chain.setup_repeater_protocol"><code class="docutils literal notranslate"><span class="pre">setup_repeater_protocol()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater_chain.html#netsquid.examples.repeater_chain.setup_datacollector"><code class="docutils literal notranslate"><span class="pre">setup_datacollector()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater_chain.html#netsquid.examples.repeater_chain.run_simulation"><code class="docutils literal notranslate"><span class="pre">run_simulation()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_examples/netsquid.examples.repeater_chain.html#netsquid.examples.repeater_chain.create_plot"><code class="docutils literal notranslate"><span class="pre">create_plot()</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_examples/netsquid.examples.simple_link.html">netsquid.examples.simple_link</a></li>
<li class="toctree-l1"><a class="reference internal" href="api_examples/netsquid.examples.magic_simple_link.html">netsquid.examples.magic_simple_link</a></li>
</ul>
</div>
</section>
        ...
        <a href="api_util/netsquid.util.constrainedmap.html" class="btn btn-neutral float-left" title="netsquid.util.constrainedmap" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="api_examples/netsquid.examples.teleportation.html" class="btn btn-neutral float-right" title="netsquid.examples.teleportation" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
