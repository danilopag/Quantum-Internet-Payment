...
<head>
  ...
  <title>netsquid.util &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.util.simtools" href="api_util/netsquid.util.simtools.html" />
    <link rel="prev" title="netsquid.protocols.serviceprotocol" href="api_protocols/netsquid.protocols.serviceprotocol.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">netsquid.util</a><ul>
...
<li class="toctree-l1"><a class="reference internal" href="CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.util</li>
      <li class="wy-breadcrumbs-aside">
            <a href="_sources/netsquid.util.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="api_protocols/netsquid.protocols.serviceprotocol.html" class="btn btn-neutral float-left" title="netsquid.protocols.serviceprotocol" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="api_util/netsquid.util.simtools.html" class="btn btn-neutral float-right" title="netsquid.util.simtools" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="netsquid-util">
<h1>netsquid.util<a class="headerlink" href="#netsquid-util" title="Link to this heading"></a></h1>
<div class="toctree-wrapper compound">
<p class="caption" role="heading"><span class="caption-text">Modules</span></p>
<ul>
<li class="toctree-l1"><a class="reference internal" href="api_util/netsquid.util.simtools.html">netsquid.util.simtools</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.SECOND"><code class="docutils literal notranslate"><span class="pre">SECOND</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.MILLISECOND"><code class="docutils literal notranslate"><span class="pre">MILLISECOND</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.MICROSECOND"><code class="docutils literal notranslate"><span class="pre">MICROSECOND</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.NANOSECOND"><code class="docutils literal notranslate"><span class="pre">NANOSECOND</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.PICOSECOND"><code class="docutils literal notranslate"><span class="pre">PICOSECOND</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.sim_time"><code class="docutils literal notranslate"><span class="pre">sim_time()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.sim_state"><code class="docutils literal notranslate"><span class="pre">sim_state()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.sim_run"><code class="docutils literal notranslate"><span class="pre">sim_run()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.sim_stop"><code class="docutils literal notranslate"><span class="pre">sim_stop()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.sim_reset"><code class="docutils literal notranslate"><span class="pre">sim_reset()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.sim_count_events"><code class="docutils literal notranslate"><span class="pre">sim_count_events()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.sim_count_instants"><code class="docutils literal notranslate"><span class="pre">sim_count_instants()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.sim_count_handlers"><code class="docutils literal notranslate"><span class="pre">sim_count_handlers()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.sim_count_resets"><code class="docutils literal notranslate"><span class="pre">sim_count_resets()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.get_random_state"><code class="docutils literal notranslate"><span class="pre">get_random_state()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.set_random_state"><code class="docutils literal notranslate"><span class="pre">set_random_state()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simtools.html#netsquid.util.simtools.test"><code class="docutils literal notranslate"><span class="pre">test()</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_util/netsquid.util.simlog.html">netsquid.util.simlog</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simlog.html#netsquid.util.simlog.logger"><code class="docutils literal notranslate"><span class="pre">logger</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simlog.html#netsquid.util.simlog.get_loggers"><code class="docutils literal notranslate"><span class="pre">get_loggers()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simlog.html#netsquid.util.simlog.warn_deprecated"><code class="docutils literal notranslate"><span class="pre">warn_deprecated()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simlog.html#netsquid.util.simlog.check_memory_usage"><code class="docutils literal notranslate"><span class="pre">check_memory_usage()</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_util/netsquid.util.simstats.html">netsquid.util.simstats</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.simstats.html#netsquid.util.simstats.SimStats"><code class="docutils literal notranslate"><span class="pre">SimStats</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_util/netsquid.util.datacollector.html">netsquid.util.datacollector</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.datacollector.html#netsquid.util.datacollector.DataCollector"><code class="docutils literal notranslate"><span class="pre">DataCollector</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_util/netsquid.util.cycache.html">netsquid.util.cycache</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.cycache.html#netsquid.util.cycache.LruCache"><code class="docutils literal notranslate"><span class="pre">LruCache</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_util/netsquid.util.cymath.html">netsquid.util.cymath</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.cymath.html#netsquid.util.cymath.correct_global_phase"><code class="docutils literal notranslate"><span class="pre">correct_global_phase()</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.cymath.html#netsquid.util.cymath.isclose"><code class="docutils literal notranslate"><span class="pre">isclose()</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_util/netsquid.util.constrainedmap.html">netsquid.util.constrainedmap</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.ConstrainedMap"><code class="docutils literal notranslate"><span class="pre">ConstrainedMap</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.ConstrainedMapView"><code class="docutils literal notranslate"><span class="pre">ConstrainedMapView</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.ValueConstraint"><code class="docutils literal notranslate"><span class="pre">ValueConstraint</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.positive_constr"><code class="docutils literal notranslate"><span class="pre">positive_constr</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.negative_constr"><code class="docutils literal notranslate"><span class="pre">negative_constr</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.nonnegative_constr"><code class="docutils literal notranslate"><span class="pre">nonnegative_constr</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.nonpositive_constr"><code class="docutils literal notranslate"><span class="pre">nonpositive_constr</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.not_none_constr"><code class="docutils literal notranslate"><span class="pre">not_none_constr</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.integer_constr"><code class="docutils literal notranslate"><span class="pre">integer_constr</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.ConstraintError"><code class="docutils literal notranslate"><span class="pre">ConstraintError</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.ImmutabilityError"><code class="docutils literal notranslate"><span class="pre">ImmutabilityError</span></code></a></li>
</ul>
</li>
</ul>
</div>
        ...
        <a href="api_protocols/netsquid.protocols.serviceprotocol.html" class="btn btn-neutral float-left" title="netsquid.protocols.serviceprotocol" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="api_util/netsquid.util.simtools.html" class="btn btn-neutral float-right" title="netsquid.util.simtools" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
