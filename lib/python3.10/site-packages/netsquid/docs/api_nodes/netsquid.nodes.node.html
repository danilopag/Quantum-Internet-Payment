...
<head>
  ...
  <title>netsquid.nodes.node &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.nodes.connections" href="netsquid.nodes.connections.html" />
    <link rel="prev" title="netsquid.nodes" href="../netsquid.nodes.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.nodes.node</a></li>
<li class="toctree-l3"><a class="reference internal" href="netsquid.nodes.connections.html">netsquid.nodes.connections</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.nodes.node</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_nodes/netsquid.nodes.node.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="../netsquid.nodes.html" class="btn btn-neutral float-left" title="netsquid.nodes" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.nodes.connections.html" class="btn btn-neutral float-right" title="netsquid.nodes.connections" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.nodes.node">
<span id="netsquid-nodes-node"></span><h1>netsquid.nodes.node<a class="headerlink" href="#module-netsquid.nodes.node" title="Link to this heading"></a></h1>
<p>A network node that holds and manages hardware subcomponents.</p>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.nodes.node.</span></span><span class="sig-name descname"><span class="pre">Node</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">ID</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">qmemory</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">port_names</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node" title="Link to this definition"></a></dt>
...
<p>A network node that holds and manages hardware subcomponents.</p>
<p>A Node is a composite component: it manages a series of subcomponents
such as quantum memories, detectors, etc.</p>
<p>It’s recommended to manage nodes in the <a class="reference internal" href="netsquid.nodes.network.html#netsquid.nodes.network.Network" title="netsquid.nodes.network.Network"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Network</span></code></a> component.
This class helps setting up and managing Nodes and <a class="reference internal" href="netsquid.nodes.connections.html#netsquid.nodes.connections.Connection" title="netsquid.nodes.connections.Connection"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Connection</span></code></a>s between them.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>name</strong> (<em>str</em>) – Name of node for display purposes.</p></li>
<li><p><strong>ID</strong> (<em>int, optional</em>) – Unique identifier for node e.g. its IP address.</p></li>
<li><p><strong>qmemory</strong> (<a class="reference internal" href="../api_components/netsquid.components.qmemory.html#netsquid.components.qmemory.QuantumMemory" title="netsquid.components.qmemory.QuantumMemory"><code class="xref py py-obj docutils literal notranslate"><span class="pre">netsquid.components.qmemory.QuantumMemory</span></code></a> or None, optional) – The primary quantum memory component (or a derivative thereof) on this node.</p></li>
<li><p><strong>port_names</strong> (<em>list of str or None, optional</em>) – Names of additional ports to add to this component.</p></li>
</ul>
</dd>
</dl>
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.name">
<span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#netsquid.nodes.node.Node.name" title="Link to this definition"></a></dt>
...
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.ID">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">ID</span></span><a class="headerlink" href="#netsquid.nodes.node.Node.ID" title="Link to this definition"></a></dt>
<dd><p>Identifier for node e.g. its IP address.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.cdata">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">cdata</span></span><a class="headerlink" href="#netsquid.nodes.node.Node.cdata" title="Link to this definition"></a></dt>
<dd><p>Locally held classical data.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.connection_port_name">
<em class="property"><span class="pre">static</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">connection_port_name</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">remote_ID</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">''</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node.connection_port_name" title="Link to this definition"></a></dt>
<dd><p>Gives a conventional port name for a connection to a remote node.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>remote_ID</strong> (<em>int or str</em>) – ID of remote node connection is to.</p></li>
<li><p><strong>label</strong> (<em>str, optional</em>) – Label for the connection.
The purpose of labels is to distinguish multiple connections between the same two nodes.
Default is no label (empty string).</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>Port name for the connection following the fixed naming convention.</p>
</dd>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.connect_to">
<span class="sig-name descname"><span class="pre">connect_to</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">remote_node</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">connection</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">''</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">local_port_name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">remote_port_name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node.connect_to" title="Link to this definition"></a></dt>
<dd><p>Connect to a remote node with a connection or a channel.</p>
<p>This method will assign <a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Port" title="netsquid.components.component.Port"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Port</span></code></a>s on
each node that <em>connect</em> to the connection’s ports on both ends.
By default these ports will use the standard port naming convention
(see <code class="xref py py-meth docutils literal notranslate"><span class="pre">Netsquid.nodes.node.Node.connection_port_name()</span></code>).
If the ports do not already exist they are added.</p>
<p>For adding multiple connections between a single pair of nodes, use the parameter <code class="docutils literal notranslate"><span class="pre">label</span></code> to create
additional ports with the standard naming convention, or use the parameters <code class="docutils literal notranslate"><span class="pre">local_port_name</span></code> and
<code class="docutils literal notranslate"><span class="pre">remote_port_name</span></code> to use existing but unused ports or create new ports with these names.</p>
<p>For convenience, if a one-way <a class="reference internal" href="../api_components/netsquid.components.channel.html#netsquid.components.channel.Channel" title="netsquid.components.channel.Channel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Channel</span></code></a> is given, it is wrapped
within a new <a class="reference internal" href="netsquid.nodes.connections.html#netsquid.nodes.connections.DirectConnection" title="netsquid.nodes.connections.DirectConnection"><code class="xref py py-obj docutils literal notranslate"><span class="pre">DirectConnection</span></code></a> component.
In this case this node is the transmitter and the remote node the receiver. For two-way communication,
wrap two <code class="xref py py-obj docutils literal notranslate"><span class="pre">DirectConnection</span></code>
first.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>remote_node</strong> (<a class="reference internal" href="#netsquid.nodes.node.Node" title="netsquid.nodes.node.Node"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Node</span></code></a>) – Remote node to connect to.</p></li>
<li><p><strong>connection</strong> (<a class="reference internal" href="netsquid.nodes.connections.html#netsquid.nodes.connections.Connection" title="netsquid.nodes.connections.Connection"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Connection</span></code></a> or                     <a class="reference internal" href="../api_components/netsquid.components.channel.html#netsquid.components.channel.Channel" title="netsquid.components.channel.Channel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Channel</span></code></a>) – Linking component. Can be a connection or a channel. If it is the latter, the channel will be
be made the subcomponent of a new <a class="reference internal" href="netsquid.nodes.connections.html#netsquid.nodes.connections.DirectConnection" title="netsquid.nodes.connections.DirectConnection"><code class="xref py py-obj docutils literal notranslate"><span class="pre">DirectConnection</span></code></a> component.</p></li>
<li><p><strong>label</strong> (<em>str, optional</em>) – Label to use for this connection if the standard port naming convention is used
(see <code class="xref py py-meth docutils literal notranslate"><span class="pre">Netsquid.nodes.node.Node.connection_port_name()</span></code>).
The purpose of labels is to distinguish multiple connection between the same two nodes.
Default is no label (empty string).</p></li>
<li><p><strong>local_port_name</strong> (<em>str or None, optional</em>) – Name of port to use on local node. If a port with this name does not exist one will be added.
If it does exist it should not be connected. If None (default), a new port is added using the
standard naming convention (see <code class="xref py py-meth docutils literal notranslate"><span class="pre">Netsquid.nodes.node.Node.connection_port_name()</span></code>).</p></li>
<li><p><strong>remote_port_name</strong> (<em>str or None, optional</em>) – Name of port to use on remote node. If a port with this name does not exist one will be added.
If it does exist it should not be connected. If None (default), a new port is added using the
standard naming convention (see <code class="xref py py-meth docutils literal notranslate"><span class="pre">Netsquid.nodes.node.Node.connection_port_name()</span></code>).</p></li>
</ul>
</dd>
...
<li><p><em>str</em> – Name of the connecting <a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Port" title="netsquid.components.component.Port"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Port</span></code></a> on this node.</p></li>
<li><p><em>str</em> – Name of the connecting <a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Port" title="netsquid.components.component.Port"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Port</span></code></a> on the remote node.</p></li>
</ul>
</p>
</dd>
<dt class="field-odd">Raises<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.PortConnectError" title="netsquid.components.component.PortConnectError"><strong>PortConnectError</strong></a> – If there is already a connection between two ports with the same name or <code class="docutils literal notranslate"><span class="pre">label</span></code>.</p>
</dd>
</dl>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.add_ports">
<span class="sig-name descname"><span class="pre">add_ports</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">names</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node.add_ports" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.add_property">
<span class="sig-name descname"><span class="pre">add_property</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">mutable</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_constraints</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node.add_property" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.has_subcomponent">
<span class="sig-name descname"><span class="pre">has_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node.has_subcomponent" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.has_supercomponent">
<span class="sig-name descname"><span class="pre">has_supercomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node.has_supercomponent" title="Link to this definition"></a></dt>
<dd><p>Whether argument is a supercomponent of this component at any level.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.models">
<span class="sig-name descname"><span class="pre">models</span></span><a class="headerlink" href="#netsquid.nodes.node.Node.models" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.ports">
<span class="sig-name descname"><span class="pre">ports</span></span><a class="headerlink" href="#netsquid.nodes.node.Node.ports" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.properties">
<span class="sig-name descname"><span class="pre">properties</span></span><a class="headerlink" href="#netsquid.nodes.node.Node.properties" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.rem_subcomponent">
<span class="sig-name descname"><span class="pre">rem_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node.rem_subcomponent" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.remove">
<span class="sig-name descname"><span class="pre">remove</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node.remove" title="Link to this definition"></a></dt>
<dd><p>Removes the entity from the simulation.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.specify_model">
<span class="sig-name descname"><span class="pre">specify_model</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">model_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node.specify_model" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.subcomponents">
<span class="sig-name descname"><span class="pre">subcomponents</span></span><a class="headerlink" href="#netsquid.nodes.node.Node.subcomponents" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.supercomponent">
<span class="sig-name descname"><span class="pre">supercomponent</span></span><a class="headerlink" href="#netsquid.nodes.node.Node.supercomponent" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.uid">
<span class="sig-name descname"><span class="pre">uid</span></span><a class="headerlink" href="#netsquid.nodes.node.Node.uid" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.get_conn_port">
<span class="sig-name descname"><span class="pre">get_conn_port</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">remote_ID</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">''</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node.get_conn_port" title="Link to this definition"></a></dt>
<dd><p>Get the port for a connection to a remote node using the standard port naming convention.</p>
<p>To add connection via ports that use the standard port naming convention use the
<a class="reference internal" href="#netsquid.nodes.node.Node.connect_to" title="netsquid.nodes.node.Node.connect_to"><code class="xref py py-meth docutils literal notranslate"><span class="pre">connect_to()</span></code></a> method.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>remote_ID</strong> (<em>int</em>) – ID of remote node.</p></li>
<li><p><strong>label</strong> (<em>str, optional</em>) – Label used to distinguish the connection from other connections to the same node.
Default is no label (empty string).</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>The local port connecting to the remote node. If no such port exists
None is returned.</p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Port" title="netsquid.components.component.Port"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Port</span></code></a> or None</p>
</dd>
</dl>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">kwargs</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node.reset" title="Link to this definition"></a></dt>
<dd><p>Reset node.</p>
<p>Resets all components and optionally clears any classical data.</p>
</dd></dl>

<dl class="py property">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.qmemory">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">qmemory</span></span><a class="headerlink" href="#netsquid.nodes.node.Node.qmemory" title="Link to this definition"></a></dt>
<dd><p>The primary quantum memory, if present.</p>
<dl class="field-list simple">
<dt class="field-odd">Returns<span class="colon">:</span></dt>
<dd class="field-odd"><p>The primary quantum memory on this node.</p>
</dd>
<dt class="field-even">Return type<span class="colon">:</span></dt>
<dd class="field-even"><p><a class="reference internal" href="../api_components/netsquid.components.qmemory.html#netsquid.components.qmemory.QuantumMemory" title="netsquid.components.qmemory.QuantumMemory"><code class="xref py py-obj docutils literal notranslate"><span class="pre">QuantumMemory</span></code></a> or None</p>
</dd>
</dl>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.node.Node.add_subcomponent">
<span class="sig-name descname"><span class="pre">add_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">forward_input</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">forward_output</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">add_ports</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">False</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.node.Node.add_subcomponent" title="Link to this definition"></a></dt>
...
<span class="gp">... </span>    <span class="n">forward_output</span><span class="o">=</span><span class="p">[(</span><span class="s2">&quot;out_p&quot;</span><span class="p">,</span> <span class="s2">&quot;out_c&quot;</span><span class="p">)])</span>
        ...
        <a href="../netsquid.nodes.html" class="btn btn-neutral float-left" title="netsquid.nodes" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.nodes.connections.html" class="btn btn-neutral float-right" title="netsquid.nodes.connections" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
