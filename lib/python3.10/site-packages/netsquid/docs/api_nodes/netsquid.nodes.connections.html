...
<head>
  ...
  <title>netsquid.nodes.connections &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.nodes.network" href="netsquid.nodes.network.html" />
    <link rel="prev" title="netsquid.nodes.node" href="netsquid.nodes.node.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="reference internal" href="../netsquid.nodes.html">netsquid.nodes</a><ul class="current">
<li class="toctree-l3"><a class="reference internal" href="netsquid.nodes.node.html">netsquid.nodes.node</a></li>
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.nodes.connections</a></li>
<li class="toctree-l3"><a class="reference internal" href="netsquid.nodes.network.html">netsquid.nodes.network</a></li>
</ul>
</li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      <li><a href="../index.html" class="icon icon-home" aria-label="Home"></a></li>
          ...
          <li class="breadcrumb-item"><a href="../netsquid.nodes.html">netsquid.nodes</a></li>
      <li class="breadcrumb-item active">netsquid.nodes.connections</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_nodes/netsquid.nodes.connections.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.nodes.node.html" class="btn btn-neutral float-left" title="netsquid.nodes.node" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.nodes.network.html" class="btn btn-neutral float-right" title="netsquid.nodes.network" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.nodes.connections">
<span id="netsquid-nodes-connections"></span><h1>netsquid.nodes.connections<a class="headerlink" href="#module-netsquid.nodes.connections" title="Link to this heading"></a></h1>
<p>A Connection represents an abstract communication link between two remote locations.
It can may consist of sub-components such as classical or quantum channels.</p>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.nodes.connections.</span></span><span class="sig-name descname"><span class="pre">Connection</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.Connection" title="Link to this definition"></a></dt>
<dd><p>Bases: <a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Component" title="netsquid.components.component.Component"><code class="xref py py-class docutils literal notranslate"><span class="pre">Component</span></code></a></p>
<p>An abstract communication link between two remote locations.</p>
<p>A connection is a <a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Component" title="netsquid.components.component.Component"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Component</span></code></a> that
may consist of sub-components such as classical/and or quantum channels, etc.</p>
<p>It defines two remote <a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Port" title="netsquid.components.component.Port"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Port</span></code></a>s named <code class="docutils literal notranslate"><span class="pre">A</span></code> and <code class="docutils literal notranslate"><span class="pre">B</span></code>.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>name</strong> (<em>str</em>) – Name of connection for identification and display purposes.</p>
</dd>
<dt class="field-even">Ports<span class="colon">:</span></dt>
<dd class="field-even"><ul class="simple">
<li><p><strong>A</strong> – Port for IO at remote location A.</p></li>
<li><p><strong>B</strong> – Port for IO at remote location B.</p></li>
</ul>
</dd>
</dl>
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.port_A">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">port_A</span></span><a class="headerlink" href="#netsquid.nodes.connections.Connection.port_A" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.port_B">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">port_B</span></span><a class="headerlink" href="#netsquid.nodes.connections.Connection.port_B" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.add_ports">
<span class="sig-name descname"><span class="pre">add_ports</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">names</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.Connection.add_ports" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.add_property">
<span class="sig-name descname"><span class="pre">add_property</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">mutable</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_constraints</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.Connection.add_property" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.has_subcomponent">
<span class="sig-name descname"><span class="pre">has_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.Connection.has_subcomponent" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.has_supercomponent">
<span class="sig-name descname"><span class="pre">has_supercomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.Connection.has_supercomponent" title="Link to this definition"></a></dt>
<dd><p>Whether argument is a supercomponent of this component at any level.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.models">
<span class="sig-name descname"><span class="pre">models</span></span><a class="headerlink" href="#netsquid.nodes.connections.Connection.models" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.name">
<span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#netsquid.nodes.connections.Connection.name" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.ports">
<span class="sig-name descname"><span class="pre">ports</span></span><a class="headerlink" href="#netsquid.nodes.connections.Connection.ports" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.properties">
<span class="sig-name descname"><span class="pre">properties</span></span><a class="headerlink" href="#netsquid.nodes.connections.Connection.properties" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.rem_subcomponent">
<span class="sig-name descname"><span class="pre">rem_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.Connection.rem_subcomponent" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.remove">
<span class="sig-name descname"><span class="pre">remove</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.Connection.remove" title="Link to this definition"></a></dt>
<dd><p>Removes the entity from the simulation.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.Connection.reset" title="Link to this definition"></a></dt>
<dd><p>Reset the component.</p>
<p>Will reset all of its ports and (sub)components.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.specify_model">
<span class="sig-name descname"><span class="pre">specify_model</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">model_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.Connection.specify_model" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.subcomponents">
<span class="sig-name descname"><span class="pre">subcomponents</span></span><a class="headerlink" href="#netsquid.nodes.connections.Connection.subcomponents" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.supercomponent">
<span class="sig-name descname"><span class="pre">supercomponent</span></span><a class="headerlink" href="#netsquid.nodes.connections.Connection.supercomponent" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.Connection.uid">
<span class="sig-name descname"><span class="pre">uid</span></span><a class="headerlink" href="#netsquid.nodes.connections.Connection.uid" title="Link to this definition"></a></dt>
...
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.nodes.connections.</span></span><span class="sig-name descname"><span class="pre">DirectConnection</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">channel_AtoB</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">channel_BtoA</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection" title="Link to this definition"></a></dt>
<dd><p>Bases: <a class="reference internal" href="#netsquid.nodes.connections.Connection" title="netsquid.nodes.connections.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a></p>
<p>A two-way direct connection consisting of one-way channels in both directions.</p>
<p>It is possible for either of the one-way channels to be unspecified, in which case
attempted communication in that direction will do nothing.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>name</strong> (<em>str</em>) – Name of connection for identification and display purposes.</p></li>
<li><p><strong>channel_AtoB</strong> (<a class="reference internal" href="../api_components/netsquid.components.channel.html#netsquid.components.channel.Channel" title="netsquid.components.channel.Channel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Channel</span></code></a> or None, optional) – One-way channel connecting end A to end B.</p></li>
<li><p><strong>channel_BtoA</strong> (<a class="reference internal" href="../api_components/netsquid.components.channel.html#netsquid.components.channel.Channel" title="netsquid.components.channel.Channel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Channel</span></code></a> or None, optional) – One-way channel connecting end B to end A.</p></li>
</ul>
</dd>
<dt class="field-even">Ports<span class="colon">:</span></dt>
<dd class="field-even"><ul class="simple">
...
<dt class="field-odd">Subcomponents<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>channel_AtoB</strong> – One-way channel from node A to B.</p></li>
<li><p><strong>channel_BtoA</strong> – One-way channel from node B to A.</p></li>
</ul>
</dd>
</dl>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.add_ports">
<span class="sig-name descname"><span class="pre">add_ports</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">names</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.add_ports" title="Link to this definition"></a></dt>
<dd><p>Add ports to this component.</p>
<p>Added ports are accessible via <a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Component.ports" title="netsquid.components.component.Component.ports"><code class="xref py py-attr docutils literal notranslate"><span class="pre">ports</span></code></a>.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.add_property">
<span class="sig-name descname"><span class="pre">add_property</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">mutable</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_constraints</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.add_property" title="Link to this definition"></a></dt>
<dd><p>Add a property to this component.</p>
<p>Properties can be accessed and modified via the
<a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Component.properties" title="netsquid.components.component.Component.properties"><code class="xref py py-attr docutils literal notranslate"><span class="pre">properties</span></code></a> attribute.</p>
<p>If a property with this name already exists, an attempt will be made to
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.add_subcomponent">
<span class="sig-name descname"><span class="pre">add_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">forward_input</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">forward_output</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">add_ports</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">False</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.add_subcomponent" title="Link to this definition"></a></dt>
<dd><p>Add a subcomponent to this component.</p>
<p>Subcomponents can be accessed using the
<a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Component.subcomponents" title="netsquid.components.component.Component.subcomponents"><code class="xref py py-attr docutils literal notranslate"><span class="pre">subcomponents</span></code></a> property.</p>
<p>If a component already exists with this name identifier it will be replaced.</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.has_subcomponent">
<span class="sig-name descname"><span class="pre">has_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.has_subcomponent" title="Link to this definition"></a></dt>
<dd><p>Whether argument is a subcomponent of this component at any level.</p>
<dl class="field-list simple">
<dt class="field-odd">Returns<span class="colon">:</span></dt>
<dd class="field-odd"><p>True if component contained as a subcomponent at any level, otherwise False.</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.has_supercomponent">
<span class="sig-name descname"><span class="pre">has_supercomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.has_supercomponent" title="Link to this definition"></a></dt>
<dd><p>Whether argument is a supercomponent of this component at any level.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.models">
<span class="sig-name descname"><span class="pre">models</span></span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.models" title="Link to this definition"></a></dt>
<dd><p>the models associated with this component.</p>
<p>Models that a component can hold are strictly define at construction.
To change the model use:
<code class="xref py py-meth docutils literal notranslate"><span class="pre">models[name_model]</span> <span class="pre">=</span> <span class="pre">model()</span></code>.</p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.name">
<span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.name" title="Link to this definition"></a></dt>
<dd><p>Name of component for identification and display purposes.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p>str</p>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.port_A">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">port_A</span></span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.port_A" title="Link to this definition"></a></dt>
<dd><p>port for IO at remote location A.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Port" title="netsquid.components.component.Port"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Port</span></code></a></p>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.port_B">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">port_B</span></span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.port_B" title="Link to this definition"></a></dt>
<dd><p>port for IO at remote location B.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Port" title="netsquid.components.component.Port"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Port</span></code></a></p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.ports">
<span class="sig-name descname"><span class="pre">ports</span></span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.ports" title="Link to this definition"></a></dt>
<dd><p>ports belonging to this component.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.ConstrainedMap" title="netsquid.util.constrainedmap.ConstrainedMap"><code class="xref py py-obj docutils literal notranslate"><span class="pre">ConstrainedMap</span></code></a></p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.properties">
<span class="sig-name descname"><span class="pre">properties</span></span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.properties" title="Link to this definition"></a></dt>
<dd><p>the properties associated with this component.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_util/netsquid.util.constrainedmap.html#netsquid.util.constrainedmap.ConstrainedMap" title="netsquid.util.constrainedmap.ConstrainedMap"><code class="xref py py-obj docutils literal notranslate"><span class="pre">ConstrainedMap</span></code></a></p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.rem_subcomponent">
<span class="sig-name descname"><span class="pre">rem_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.rem_subcomponent" title="Link to this definition"></a></dt>
<dd><p>Remove a subcomponent from this component.</p>
<p>Outgoing port connections are disconnected to keep the hierarchy consistent;
That means that any port connections to the parent or siblings are disconnected.
Input ports to subcomponents remain.</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.remove">
<span class="sig-name descname"><span class="pre">remove</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.remove" title="Link to this definition"></a></dt>
<dd><p>Removes the entity from the simulation.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.reset" title="Link to this definition"></a></dt>
<dd><p>Reset the component.</p>
<p>Will reset all of its ports and (sub)components.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.specify_model">
<span class="sig-name descname"><span class="pre">specify_model</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">model_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.specify_model" title="Link to this definition"></a></dt>
<dd><p>Specify the model types needed by this component.</p>
<p>Models that are not first specified cannot be set. To set a model do
<cite>Component.models[name_model] = model</cite>.</p>
<dl class="field-list simple">
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.subcomponents">
<span class="sig-name descname"><span class="pre">subcomponents</span></span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.subcomponents" title="Link to this definition"></a></dt>
<dd><p>Return list of subcomponents of this component and their identifiers.</p>
<dl class="field-list simple">
<dt class="field-odd">Returns<span class="colon">:</span></dt>
<dd class="field-odd"><p>Subcomponents of this component.</p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.supercomponent">
<span class="sig-name descname"><span class="pre">supercomponent</span></span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.supercomponent" title="Link to this definition"></a></dt>
<dd><p>parent component, if any.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Component" title="netsquid.components.component.Component"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Component</span></code></a> or None</p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.uid">
<span class="sig-name descname"><span class="pre">uid</span></span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.uid" title="Link to this definition"></a></dt>
<dd><p>returns a unique identifier for this entity in the simulation.</p>
<p>Each entity has a unique identifier in the simulation.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.channel_AtoB">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">channel_AtoB</span></span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.channel_AtoB" title="Link to this definition"></a></dt>
<dd><p>one-way channel from node A to B.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_components/netsquid.components.channel.html#netsquid.components.channel.Channel" title="netsquid.components.channel.Channel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Channel</span></code></a> or None</p>
</dd>
</dl>
</dd></dl>

<dl class="py property">
<dt class="sig sig-object py" id="netsquid.nodes.connections.DirectConnection.channel_BtoA">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">channel_BtoA</span></span><a class="headerlink" href="#netsquid.nodes.connections.DirectConnection.channel_BtoA" title="Link to this definition"></a></dt>
<dd><p>one-way channel from node B to A.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_components/netsquid.components.channel.html#netsquid.components.channel.Channel" title="netsquid.components.channel.Channel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Channel</span></code></a> or None</p>
</dd>
        ...
        <a href="netsquid.nodes.node.html" class="btn btn-neutral float-left" title="netsquid.nodes.node" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.nodes.network.html" class="btn btn-neutral float-right" title="netsquid.nodes.network" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
