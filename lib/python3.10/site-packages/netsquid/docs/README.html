...
<head>
  ...
  <title>NetSquid: the Network Simulator for Quantum Information using Discrete events &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="Installing the NetSquid package" href="INSTALL.html" />
    <link rel="prev" title="NetSquid" href="index.html" /> 
</head>
...
<li class="toctree-l1"><a class="reference internal" href="CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">NetSquid: the Network Simulator for Quantum Information using Discrete events</li>
      <li class="wy-breadcrumbs-aside">
            <a href="_sources/README.md.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="index.html" class="btn btn-neutral float-left" title="NetSquid" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="INSTALL.html" class="btn btn-neutral float-right" title="Installing the NetSquid package" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="netsquid-the-network-simulator-for-quantum-information-using-discrete-events">
<h1>NetSquid: the Network Simulator for Quantum Information using Discrete events<a class="headerlink" href="#netsquid-the-network-simulator-for-quantum-information-using-discrete-events" title="Link to this heading"></a></h1>
<p>The Python package NetSquid provides a quantum network simulation platform by integrating the quantum information processing capabilities of a quantum computing simulator with the event-driven time management of a classical network simulator.
...
It is being developed for the QuTech <a class="reference external" href="https://qutech.nl/research-engineering/quantum-internet/">Quantum Internet division</a> as a collaboration between TNO and TUDelft.</p>
<p>The documentation for NetSquid, including a tutorial and examples, is available <a class="reference external" href="https://docs.netsquid.org/">online</a> and in the <em>docs/</em> directory of the python package.
A paper about the NetSquid simulator and several of its use cases is available <a class="reference external" href="https://www.nature.com/articles/s42005-021-00647-8">online</a> (<a class="reference external" href="https://arxiv.org/abs/2010.12535">ArXiv link</a>.</p>
<p>See the <a class="reference internal" href="INSTALL.html"><span class="doc">INSTALL.md</span></a> file for instructions of how to install the package as a user or <a class="reference internal" href="INSTALL-SOURCE.html"><span class="doc">INSTALL-SOURCE.md</span></a> for how to build and install from the source repository as a NetSquid developer.</p>
<p>The <a class="reference external" href="https://forum.netsquid.org">NetSquid forum</a> can be used to report issues and bugs, request features, share results and experiences, and general discussions.</p>
<p>The <a class="reference internal" href="RELEASE.html"><span class="doc">RELEASE.md</span></a> file lists any important changes made by a new release or patch that users should be aware of, such as new features, breaking changes, deprecations, etc. The <a class="reference internal" href="CHANGELOG.html"><span class="doc">CHANGELOG.md</span></a> file lists incremental changes to the repository by date that are relevant for NetSquid developers and contributors. If you have access to the source repository and want to contribute to NetSquid see <a class="reference internal" href="CONTRIBUTING.html"><span class="doc">CONTRIBUTING.md</span></a>.</p>
<p>NetSquid’s core developers and contributors are listed in the <a class="reference internal" href="AUTHORS.html"><span class="doc">AUTHORS</span></a> file.
The user license can be found in the <a class="reference internal" href="LICENSE.html"><span class="doc">LICENSE</span></a> file.</p>
</section>
        ...
        <a href="index.html" class="btn btn-neutral float-left" title="NetSquid" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="INSTALL.html" class="btn btn-neutral float-right" title="Installing the NetSquid package" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
