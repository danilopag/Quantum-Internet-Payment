...
<head>
  ...
  <title>netsquid.protocols &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.protocols.protocol" href="api_protocols/netsquid.protocols.protocol.html" />
    <link rel="prev" title="netsquid.nodes.network" href="api_nodes/netsquid.nodes.network.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">netsquid.protocols</a><ul>
...
<li class="toctree-l1"><a class="reference internal" href="CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.protocols</li>
      <li class="wy-breadcrumbs-aside">
            <a href="_sources/netsquid.protocols.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="api_nodes/netsquid.nodes.network.html" class="btn btn-neutral float-left" title="netsquid.nodes.network" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="api_protocols/netsquid.protocols.protocol.html" class="btn btn-neutral float-right" title="netsquid.protocols.protocol" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="netsquid-protocols">
<h1>netsquid.protocols<a class="headerlink" href="#netsquid-protocols" title="Link to this heading"></a></h1>
<p>Protocols are <em>virtual</em> entities (<a class="reference internal" href="pydynaa.html#pydynaa.core.Entity" title="pydynaa.core.Entity"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Entity</span></code></a>) that manipulate components (<a class="reference internal" href="api_components/netsquid.components.component.html#netsquid.components.component.Component" title="netsquid.components.component.Component"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Component</span></code></a>).
Protocols derive from a <a class="reference internal" href="api_protocols/netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Protocol</span></code></a> base class and are initialised with the node(s) they need to operate with.</p>
<p>The protocol classes make use of inheritance.</p>
<div class="toctree-wrapper compound">
<p class="caption" role="heading"><span class="caption-text">Modules</span></p>
<ul>
<li class="toctree-l1"><a class="reference internal" href="api_protocols/netsquid.protocols.protocol.html">netsquid.protocols.protocol</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_protocols/netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol"><code class="docutils literal notranslate"><span class="pre">Protocol</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_protocols/netsquid.protocols.protocol.html#netsquid.protocols.protocol.Signals"><code class="docutils literal notranslate"><span class="pre">Signals</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_protocols/netsquid.protocols.protocol.html#netsquid.protocols.protocol.SignalResult"><code class="docutils literal notranslate"><span class="pre">SignalResult</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_protocols/netsquid.protocols.nodeprotocols.html">netsquid.protocols.nodeprotocols</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_protocols/netsquid.protocols.nodeprotocols.html#netsquid.protocols.nodeprotocols.LocalProtocol"><code class="docutils literal notranslate"><span class="pre">LocalProtocol</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_protocols/netsquid.protocols.nodeprotocols.html#netsquid.protocols.nodeprotocols.NodeProtocol"><code class="docutils literal notranslate"><span class="pre">NodeProtocol</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_protocols/netsquid.protocols.nodeprotocols.html#netsquid.protocols.nodeprotocols.DataNodeProtocol"><code class="docutils literal notranslate"><span class="pre">DataNodeProtocol</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_protocols/netsquid.protocols.nodeprotocols.html#netsquid.protocols.nodeprotocols.TimedNodeProtocol"><code class="docutils literal notranslate"><span class="pre">TimedNodeProtocol</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_protocols/netsquid.protocols.serviceprotocol.html">netsquid.protocols.serviceprotocol</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_protocols/netsquid.protocols.serviceprotocol.html#netsquid.protocols.serviceprotocol.ServiceProtocol"><code class="docutils literal notranslate"><span class="pre">ServiceProtocol</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_protocols/netsquid.protocols.serviceprotocol.html#netsquid.protocols.serviceprotocol.ServiceError"><code class="docutils literal notranslate"><span class="pre">ServiceError</span></code></a></li>
</ul>
</li>
</ul>
</div>
        ...
        <a href="api_nodes/netsquid.nodes.network.html" class="btn btn-neutral float-left" title="netsquid.nodes.network" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="api_protocols/netsquid.protocols.protocol.html" class="btn btn-neutral float-right" title="netsquid.protocols.protocol" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
