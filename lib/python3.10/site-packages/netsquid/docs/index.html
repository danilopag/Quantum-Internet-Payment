...
<head>
  ...
  <title>NetSquid &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="NetSquid: the Network Simulator for Quantum Information using Discrete events" href="README.html" /> 
</head>
...
<li class="toctree-l1"><a class="reference internal" href="CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">NetSquid</li>
      <li class="wy-breadcrumbs-aside">
            <a href="_sources/index.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="README.html" class="btn btn-neutral float-right" title="NetSquid: the Network Simulator for Quantum Information using Discrete events" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="netsquid">
<h1>NetSquid<a class="headerlink" href="#netsquid" title="Link to this heading"></a></h1>
<p>Welcome to the documentation pages for <strong>NetSquid</strong>, the <strong>Net</strong>work <strong>S</strong>imulator for <strong>Qu</strong>antum <strong>I</strong>nformation using <strong>D</strong>iscrete events.
The key features of NetSquid include:</p>
<ul class="simple">
<li><p>The use of a discrete event simulator to simulate delays in transmission and computation.</p></li>
<li><p>Extendable libraries of network components and protocols.</p></li>
<li><p>Multiple qubit <em>quantum state formalisms</em> available: trade offs include versatility, speed, and memory efficiency.</p></li>
<li><p>A Python 3 package that uses Numpy/SciPy, Cython, and C++ under the hood.</p></li>
</ul>
<p>Please check you are reading the documentation that matches your version of NetSquid.
Other versions can be selected with the menu at the bottom of the navigation panel.</p>
...
<p>For a brief introduction to NetSquid see this <a class="reference external" href="https://docs.netsquid.org/talks/QIA-lisbon_NetSquid_rob_2019-5-14_v1.pdf">QIA NetSquid presentation</a>.</p>
<p>Join the <a class="reference external" href="https://forum.netsquid.org">NetSquid forum</a> to follow the latest announcements, report issues, and discuss with developers.</p>
<div class="toctree-wrapper compound">
<p class="caption" role="heading"><span class="caption-text">Learn NetSquid</span></p>
<ul>
<li class="toctree-l1"><a class="reference internal" href="quick_start.html">NetSquid in 10 minutes</a></li>
...
<ul>
<li class="toctree-l1"><a class="reference internal" href="api_reference.html">NetSquid package</a><ul>
<li class="toctree-l2"><a class="reference internal" href="netsquid.qubits.html">netsquid.qubits</a></li>
<li class="toctree-l2"><a class="reference internal" href="netsquid.components.html">netsquid.components</a></li>
<li class="toctree-l2"><a class="reference internal" href="netsquid.components.models.html">netsquid.components.models</a></li>
<li class="toctree-l2"><a class="reference internal" href="netsquid.nodes.html">netsquid.nodes</a></li>
<li class="toctree-l2"><a class="reference internal" href="netsquid.protocols.html">netsquid.protocols</a></li>
<li class="toctree-l2"><a class="reference internal" href="netsquid.util.html">netsquid.util</a></li>
<li class="toctree-l2"><a class="reference internal" href="netsquid.examples.html">netsquid.examples</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_pydynaa.html">pyDynAA package</a><ul>
<li class="toctree-l2"><a class="reference internal" href="pydynaa.html">pydynaa.Entity</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="CHANGELOG.html">Changelog</a></li>
        ...
        <a href="README.html" class="btn btn-neutral float-right" title="NetSquid: the Network Simulator for Quantum Information using Discrete events" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
