...
<head>
  ...
  <title>netsquid.protocols.serviceprotocol &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.util" href="../netsquid.util.html" />
    <link rel="prev" title="netsquid.protocols.nodeprotocols" href="netsquid.protocols.nodeprotocols.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="reference internal" href="../netsquid.protocols.html">netsquid.protocols</a><ul class="current">
<li class="toctree-l3"><a class="reference internal" href="netsquid.protocols.protocol.html">netsquid.protocols.protocol</a></li>
<li class="toctree-l3"><a class="reference internal" href="netsquid.protocols.nodeprotocols.html">netsquid.protocols.nodeprotocols</a></li>
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.protocols.serviceprotocol</a></li>
</ul>
</li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      <li><a href="../index.html" class="icon icon-home" aria-label="Home"></a></li>
          ...
          <li class="breadcrumb-item"><a href="../netsquid.protocols.html">netsquid.protocols</a></li>
      <li class="breadcrumb-item active">netsquid.protocols.serviceprotocol</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_protocols/netsquid.protocols.serviceprotocol.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.protocols.nodeprotocols.html" class="btn btn-neutral float-left" title="netsquid.protocols.nodeprotocols" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="../netsquid.util.html" class="btn btn-neutral float-right" title="netsquid.util" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.protocols.serviceprotocol">
<span id="netsquid-protocols-serviceprotocol"></span><h1>netsquid.protocols.serviceprotocol<a class="headerlink" href="#module-netsquid.protocols.serviceprotocol" title="Link to this heading"></a></h1>
<p>Defines a base class for service protocols.</p>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.protocols.serviceprotocol.</span></span><span class="sig-name descname"><span class="pre">ServiceProtocol</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">node</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol" title="Link to this definition"></a></dt>
<dd><p>Bases: <a class="reference internal" href="netsquid.protocols.nodeprotocols.html#netsquid.protocols.nodeprotocols.NodeProtocol" title="netsquid.protocols.nodeprotocols.NodeProtocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">NodeProtocol</span></code></a></p>
<p>Extends a node protocol with an interface for service requests and responses.</p>
<p>A service protocol runs on a single node and has predefined requests and responses.
A request or response type must be registered with a unique name.
Via the <code class="xref py py-meth docutils literal notranslate"><span class="pre">put()</span></code> method a request can be submitted to the protocol.
Only requests that are registered will be handled by the protocol.
If the request is registered, it is handled by
the <code class="xref py py-meth docutils literal notranslate"><span class="pre">handle_request()</span></code> method.</p>
<p>When a request has finished the protocol is expected to return a response
using <code class="xref py py-meth docutils literal notranslate"><span class="pre">send_response()</span></code>.
This response should match one of the registered response types.
The response is send as a signal, where the the name of the response type is used as signal label.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>node</strong> (<a class="reference internal" href="../api_nodes/netsquid.nodes.node.html#netsquid.nodes.node.Node" title="netsquid.nodes.node.Node"><code class="xref py py-class docutils literal notranslate"><span class="pre">Node</span></code></a>) – The node this protocol is running on</p></li>
<li><p><strong>name</strong> (<em>str, optional</em>) – The name of this protocol</p></li>
</ul>
</dd>
</dl>
<p class="rubric">Examples</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">netsquid.protocols</span> <span class="kn">import</span> <span class="n">ServiceProtocol</span>
<span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">netsquid.nodes</span> <span class="kn">import</span> <span class="n">Node</span>
...
<span class="gp">...</span>
<span class="gp">&gt;&gt;&gt; </span><span class="k">class</span> <span class="nc">Service</span><span class="p">(</span><span class="n">ServiceProtocol</span><span class="p">):</span>
<span class="gp">... </span>    <span class="n">req_write</span> <span class="o">=</span> <span class="n">namedtuple</span><span class="p">(</span><span class="s1">&#39;req_write&#39;</span><span class="p">,</span> <span class="p">[</span><span class="s1">&#39;content&#39;</span><span class="p">])</span>
<span class="gp">... </span>    <span class="n">res_ok</span> <span class="o">=</span> <span class="n">namedtuple</span><span class="p">(</span><span class="s1">&#39;res_ok&#39;</span><span class="p">,</span> <span class="p">[</span><span class="s1">&#39;content&#39;</span><span class="p">])</span>
<span class="gp">...</span>
<span class="gp">... </span>    <span class="k">def</span> <span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">node</span><span class="p">,</span> <span class="n">name</span><span class="o">=</span><span class="kc">None</span><span class="p">):</span>
<span class="gp">... </span>        <span class="nb">super</span><span class="p">()</span><span class="o">.</span><span class="fm">__init__</span><span class="p">(</span><span class="n">node</span><span class="o">=</span><span class="n">node</span><span class="p">,</span> <span class="n">name</span><span class="o">=</span><span class="n">name</span><span class="p">)</span>
<span class="gp">... </span>        <span class="bp">self</span><span class="o">.</span><span class="n">register_request</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">req_write</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">write</span><span class="p">)</span>
<span class="gp">... </span>        <span class="bp">self</span><span class="o">.</span><span class="n">register_response</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">res_ok</span><span class="p">)</span>
<span class="gp">...</span>
<span class="gp">... </span>    <span class="k">def</span> <span class="nf">write</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">req</span><span class="p">):</span>
<span class="gp">... </span>        <span class="c1"># We will just print for now</span>
<span class="gp">... </span>        <span class="nb">print</span><span class="p">(</span><span class="n">req</span><span class="p">)</span>
<span class="gp">... </span>        <span class="n">res</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">res_ok</span><span class="p">(</span><span class="s1">&#39;Done&#39;</span><span class="p">)</span>
<span class="gp">... </span>        <span class="bp">self</span><span class="o">.</span><span class="n">send_response</span><span class="p">(</span><span class="n">res</span><span class="p">)</span>
<span class="gp">...</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">service</span> <span class="o">=</span> <span class="n">Service</span><span class="p">(</span><span class="n">Node</span><span class="p">(</span><span class="s2">&quot;Alice&quot;</span><span class="p">))</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">request</span> <span class="o">=</span> <span class="n">Service</span><span class="o">.</span><span class="n">req_write</span><span class="p">(</span><span class="n">content</span><span class="o">=</span><span class="s1">&#39;Hello, world!&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">service</span><span class="o">.</span><span class="n">put</span><span class="p">(</span><span class="n">request</span><span class="p">)</span>
<span class="go">req_write(content=&#39;Hello, world!&#39;)</span>
</pre></div>
</div>
<p>It is also possible to re-use the same request or response type.
Unique names are used to differentiate between them.</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">service</span><span class="o">.</span><span class="n">register_request</span><span class="p">(</span><span class="n">service</span><span class="o">.</span><span class="n">req_write</span><span class="p">,</span> <span class="k">lambda</span> <span class="n">x</span><span class="p">:</span> <span class="nb">print</span><span class="p">(</span><span class="n">x</span><span class="o">.</span><span class="n">_fields</span><span class="p">),</span> <span class="n">name</span><span class="o">=</span><span class="s1">&#39;print&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">service</span><span class="o">.</span><span class="n">request_types</span>
<span class="go">ConstrainedMap({&#39;req_write&#39;: &lt;class &#39;__main__.req_write&#39;&gt;, &#39;print&#39;: &lt;class &#39;__main__.req_write&#39;&gt;})</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">service</span><span class="o">.</span><span class="n">put</span><span class="p">(</span><span class="n">request</span><span class="p">,</span> <span class="n">name</span><span class="o">=</span><span class="s1">&#39;print&#39;</span><span class="p">)</span>
<span class="go">(&#39;content&#39;,)</span>
</pre></div>
</div>
<p>See the <a class="reference external" href="../api_examples/netsquid.examples.simple_link.html">simple link example</a> for a full example.</p>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.get_name">
<em class="property"><span class="pre">static</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">get_name</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">obj</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.get_name" title="Link to this definition"></a></dt>
...
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.request_types">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">request_types</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.request_types" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.response_types">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">response_types</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.response_types" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.request_handlers">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">request_handlers</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.request_handlers" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.register_response">
<span class="sig-name descname"><span class="pre">register_response</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">res_type</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.register_response" title="Link to this definition"></a></dt>
...
<a class="reference internal" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.get_name" title="netsquid.protocols.serviceprotocol.ServiceProtocol.get_name"><code class="xref py py-meth docutils literal notranslate"><span class="pre">get_name()</span></code></a> of the request.</p></li>
</ul>
</dd>
<dt class="field-even">Raises<span class="colon">:</span></dt>
<dd class="field-even"><p><a class="reference internal" href="#netsquid.protocols.serviceprotocol.ServiceError" title="netsquid.protocols.serviceprotocol.ServiceError"><strong>ServiceError</strong></a> – If the name has already been registered.</p>
</dd>
</dl>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.register_request">
<span class="sig-name descname"><span class="pre">register_request</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">req_type</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">handler</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.register_request" title="Link to this definition"></a></dt>
...
<dt class="field-even">Raises<span class="colon">:</span></dt>
<dd class="field-even"><p><a class="reference internal" href="#netsquid.protocols.serviceprotocol.ServiceError" title="netsquid.protocols.serviceprotocol.ServiceError"><strong>ServiceError</strong></a> – If the name is already registered.</p>
</dd>
</dl>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.put">
<span class="sig-name descname"><span class="pre">put</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">request</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.put" title="Link to this definition"></a></dt>
...
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>The value returned by <a class="reference internal" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.handle_request" title="netsquid.protocols.serviceprotocol.ServiceProtocol.handle_request"><code class="xref py py-meth docutils literal notranslate"><span class="pre">handle_request()</span></code></a>.</p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p>object</p>
</dd>
<dt class="field-even">Raises<span class="colon">:</span></dt>
<dd class="field-even"><p><a class="reference internal" href="#netsquid.protocols.serviceprotocol.ServiceError" title="netsquid.protocols.serviceprotocol.ServiceError"><strong>ServiceError</strong></a> – If the name doesn’t match to the request type.</p>
</dd>
</dl>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.handle_request">
<span class="sig-name descname"><span class="pre">handle_request</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">request</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.handle_request" title="Link to this definition"></a></dt>
<dd><p>Handle the request to be run by the service.</p>
<p>Runs the request handler if it is not a generator.
See the <a class="reference external" href="../api_examples/netsquid.examples.simple_link.html">simple link example</a> for an example of how
to implement generators.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>request</strong> (<code class="xref py py-class docutils literal notranslate"><span class="pre">collections.namedtuple</span></code> or object) – The object representing the request.</p></li>
<li><p><strong>name</strong> (<em>str</em>) – The identifier for this request.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>The object returned by the request handler.</p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p>object</p>
</dd>
<dt class="field-even">Raises<span class="colon">:</span></dt>
<dd class="field-even"><p><strong>NotImplementedError</strong> – If the handler is a generator</p>
</dd>
</dl>
<p class="rubric">Notes</p>
<p>This method is called after <a class="reference internal" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.put" title="netsquid.protocols.serviceprotocol.ServiceProtocol.put"><code class="xref py py-meth docutils literal notranslate"><span class="pre">put()</span></code></a> which
does the type checking etc.
Objects returned here are passed to <a class="reference internal" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.put" title="netsquid.protocols.serviceprotocol.ServiceProtocol.put"><code class="xref py py-meth docutils literal notranslate"><span class="pre">put()</span></code></a> and allow
the user to return information available at the time of putting the request,
like a unique identifier or estimated time of completion.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.send_response">
<span class="sig-name descname"><span class="pre">send_response</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">response</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.send_response" title="Link to this definition"></a></dt>
...
Default <a class="reference internal" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.get_name" title="netsquid.protocols.serviceprotocol.ServiceProtocol.get_name"><code class="xref py py-meth docutils literal notranslate"><span class="pre">get_name()</span></code></a> of the request.</p></li>
</ul>
</dd>
<dt class="field-even">Raises<span class="colon">:</span></dt>
<dd class="field-even"><p><a class="reference internal" href="#netsquid.protocols.serviceprotocol.ServiceError" title="netsquid.protocols.serviceprotocol.ServiceError"><strong>ServiceError</strong></a> – If the name doesn’t match to the request type.</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.add_signal">
<span class="sig-name descname"><span class="pre">add_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">event_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.add_signal" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.add_subprotocol">
<span class="sig-name descname"><span class="pre">add_subprotocol</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">subprotocol</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.add_subprotocol" title="Link to this definition"></a></dt>
<dd><p>Add a sub-protocol to this protocol.</p>
<p>Neither protocol should be running and both protocols must be able to
signal to each other (see <a class="reference internal" href="netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol.can_signal_to" title="netsquid.protocols.protocol.Protocol.can_signal_to"><code class="xref py py-meth docutils literal notranslate"><span class="pre">can_signal_to()</span></code></a>).</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>subprotocol</strong> (<a class="reference internal" href="netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a>) – Protocol to add as a sub-protocol.</p></li>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.await_mempos_busy_toggle">
<span class="sig-name descname"><span class="pre">await_mempos_busy_toggle</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">QuantumMemory</span> <span class="pre">qmemory</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">list</span> <span class="pre">positions</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.await_mempos_busy_toggle" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.await_mempos_in_use_toggle">
<span class="sig-name descname"><span class="pre">await_mempos_in_use_toggle</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">QuantumMemory</span> <span class="pre">qmemory</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">list</span> <span class="pre">positions</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.await_mempos_in_use_toggle" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.await_port_input">
<span class="sig-name descname"><span class="pre">await_port_input</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">port</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.await_port_input" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.await_port_output">
<span class="sig-name descname"><span class="pre">await_port_output</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">port</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.await_port_output" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.await_program">
<span class="sig-name descname"><span class="pre">await_program</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">processor</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">await_done=True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">await_fail=False</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.await_program" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.await_signal">
<span class="sig-name descname"><span class="pre">await_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">Protocol</span> <span class="pre">sender</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">signal_label=Signals.FINISHED</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.await_signal" title="Link to this definition"></a></dt>
...
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>EventExpression that the protocol yields on.
The signal result can be retrieved from the protocol with <a class="reference internal" href="netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol.get_signal_result" title="netsquid.protocols.protocol.Protocol.get_signal_result"><code class="xref py py-func docutils literal notranslate"><span class="pre">get_signal_result()</span></code></a>
or with <a class="reference internal" href="netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol.get_signal_by_event" title="netsquid.protocols.protocol.Protocol.get_signal_by_event"><code class="xref py py-func docutils literal notranslate"><span class="pre">get_signal_by_event()</span></code></a></p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../pydynaa.html#pydynaa.core.EventExpression" title="pydynaa.core.EventExpression"><code class="xref py py-class docutils literal notranslate"><span class="pre">EventExpression</span></code></a></p>
</dd>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.await_timer">
<span class="sig-name descname"><span class="pre">await_timer</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">duration=0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">end_time=0</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.await_timer" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.can_signal_to">
<span class="sig-name descname"><span class="pre">can_signal_to</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">protocol</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.can_signal_to" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.check_assigned">
<em class="property"><span class="pre">static</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">check_assigned</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">inputs</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">input_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.check_assigned" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.get_signal_by_event">
<span class="sig-name descname"><span class="pre">get_signal_by_event</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">event</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">receiver</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.get_signal_by_event" title="Link to this definition"></a></dt>
...
<li><p><strong>receiver</strong> (<a class="reference internal" href="netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a> or None, optional) – The protocol wanting to receive the signal value. If not None,
will check if signalling is possible using
<a class="reference internal" href="netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol.can_signal_to" title="netsquid.protocols.protocol.Protocol.can_signal_to"><code class="xref py py-meth docutils literal notranslate"><span class="pre">can_signal_to()</span></code></a></p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
...
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="netsquid.protocols.protocol.html#netsquid.protocols.protocol.SignalResult" title="netsquid.protocols.protocol.SignalResult"><code class="xref py py-obj docutils literal notranslate"><span class="pre">SignalResult</span></code></a> or None</p>
</dd>
</dl>
<p class="rubric">Notes</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.get_signal_result">
<span class="sig-name descname"><span class="pre">get_signal_result</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">receiver</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.get_signal_result" title="Link to this definition"></a></dt>
<dd><p>Get the result of the last signal sent with this label.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>label</strong> (<code class="xref py py-obj docutils literal notranslate"><span class="pre">str</span></code> or <code class="xref py py-obj docutils literal notranslate"><span class="pre">int</span></code> or <a class="reference internal" href="netsquid.protocols.protocol.html#netsquid.protocols.protocol.Signals" title="netsquid.protocols.protocol.Signals"><code class="xref py py-class docutils literal notranslate"><span class="pre">Signals</span></code></a>) – Label that the signal was broadcasted with.</p></li>
<li><p><strong>receiver</strong> (<a class="reference internal" href="netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a> or None, optional) – The protocol wanting to receive the signal value. If not None,
...
<li><p><strong>KeyError</strong> – When the signal label is unknown i.e. hasn’t been added yet with
    <a class="reference internal" href="netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol.add_signal" title="netsquid.protocols.protocol.Protocol.add_signal"><code class="xref py py-meth docutils literal notranslate"><span class="pre">add_signal()</span></code></a>.</p></li>
</ul>
</dd>
</dl>
</dd></dl>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.is_connected">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">is_connected</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.is_connected" title="Link to this definition"></a></dt>
...
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.is_running">
<span class="sig-name descname"><span class="pre">is_running</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.is_running" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.max_nodes">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">max_nodes</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.max_nodes" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.name">
<span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.name" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.node">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">node</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.node" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.nodes">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">nodes</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.nodes" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.remove">
<span class="sig-name descname"><span class="pre">remove</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.remove" title="Link to this definition"></a></dt>
<dd><p>Removes the entity from the simulation.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.reset" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.run">
<span class="sig-name descname"><span class="pre">run</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.run" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.send_signal">
<span class="sig-name descname"><span class="pre">send_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">signal_label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">result</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.send_signal" title="Link to this definition"></a></dt>
<dd><p>Send a signal to other protocols to indicate a status change or announce a result.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>signal_label</strong> (<code class="xref py py-obj docutils literal notranslate"><span class="pre">str</span></code> or <code class="xref py py-obj docutils literal notranslate"><span class="pre">int</span></code> or <a class="reference internal" href="netsquid.protocols.protocol.html#netsquid.protocols.protocol.Signals" title="netsquid.protocols.protocol.Signals"><code class="xref py py-class docutils literal notranslate"><span class="pre">Signals</span></code></a>) – Label, key or status that is broadcasted to the world. Other protocols can wait for this signal.</p></li>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.signals">
<span class="sig-name descname"><span class="pre">signals</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.signals" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.specify_node">
<span class="sig-name descname"><span class="pre">specify_node</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.specify_node" title="Link to this definition"></a></dt>
...
<dd class="field-even"><p><strong>RuntimeError</strong> – If specifying this node will exceed the maximum number of nodes
    <a class="reference internal" href="netsquid.protocols.nodeprotocols.html#netsquid.protocols.nodeprotocols.LocalProtocol.max_nodes" title="netsquid.protocols.nodeprotocols.LocalProtocol.max_nodes"><code class="xref py py-attr docutils literal notranslate"><span class="pre">max_nodes</span></code></a>.</p>
</dd>
</dl>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.start">
<span class="sig-name descname"><span class="pre">start</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.start" title="Link to this definition"></a></dt>
...
<dt class="field-even">Return type<span class="colon">:</span></dt>
<dd class="field-even"><p><a class="reference internal" href="netsquid.protocols.protocol.html#netsquid.protocols.protocol.Protocol" title="netsquid.protocols.protocol.Protocol"><code class="xref py py-class docutils literal notranslate"><span class="pre">Protocol</span></code></a></p>
</dd>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.start_subprotocols">
<span class="sig-name descname"><span class="pre">start_subprotocols</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.start_subprotocols" title="Link to this definition"></a></dt>
<dd><p>Start all the sub-protocols in parallel.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.stop">
<span class="sig-name descname"><span class="pre">stop</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.stop" title="Link to this definition"></a></dt>
<dd><p>Stop the protocol as well as any running sub-protocols.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.subprotocols">
<span class="sig-name descname"><span class="pre">subprotocols</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.subprotocols" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceProtocol.uid">
<span class="sig-name descname"><span class="pre">uid</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceProtocol.uid" title="Link to this definition"></a></dt>
...
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceError">
<em class="property"><span class="pre">exception</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.protocols.serviceprotocol.</span></span><span class="sig-name descname"><span class="pre">ServiceError</span></span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceError" title="Link to this definition"></a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">Exception</span></code></p>
<p>An error associated to service protocols.</p>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.protocols.serviceprotocol.ServiceError.with_traceback">
<span class="sig-name descname"><span class="pre">with_traceback</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.protocols.serviceprotocol.ServiceError.with_traceback" title="Link to this definition"></a></dt>
...
set self.__traceback__ to tb and return self.</p>
        ...
        <a href="netsquid.protocols.nodeprotocols.html" class="btn btn-neutral float-left" title="netsquid.protocols.nodeprotocols" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="../netsquid.util.html" class="btn btn-neutral float-right" title="netsquid.util" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
