...
<head>
  ...
  <title>netsquid.examples.entanglenodes &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.examples.purify" href="netsquid.examples.purify.html" />
    <link rel="prev" title="netsquid.examples.teleportation" href="netsquid.examples.teleportation.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.examples.entanglenodes</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.examples.entanglenodes</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_examples/netsquid.examples.entanglenodes.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.examples.teleportation.html" class="btn btn-neutral float-left" title="netsquid.examples.teleportation" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.examples.purify.html" class="btn btn-neutral float-right" title="netsquid.examples.purify" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.examples.entanglenodes">
<span id="netsquid-examples-entanglenodes"></span><h1>netsquid.examples.entanglenodes<a class="headerlink" href="#module-netsquid.examples.entanglenodes" title="Link to this heading"></a></h1>
<p>The EntangleNodes protocol creates entanglement between two remote nodes
...
event once it is ready for retrieval.</p>
<a class="reference internal image-reference" href="../_images/aafig-389ada86c3cb4ac94bdb17d5ec0ededc4208bed2.svg"><img alt="../_images/aafig-389ada86c3cb4ac94bdb17d5ec0ededc4208bed2.svg" height="104.0" src="../_images/aafig-389ada86c3cb4ac94bdb17d5ec0ededc4208bed2.svg" width="1182.0" /></a>
<p>This network is constructed using the following function:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">example_network_setup</span><span class="p">(</span><span class="n">prep_delay</span><span class="o">=</span><span class="mi">5</span><span class="p">,</span> <span class="n">qchannel_delay</span><span class="o">=</span><span class="mi">100</span><span class="p">,</span> <span class="n">num_mem_positions</span><span class="o">=</span><span class="mi">3</span><span class="p">):</span>
<span class="w">    </span><span class="sd">&quot;&quot;&quot;Create an example network for use with the entangling nodes protocol.</span>

<span class="sd">    Parameters</span>
<span class="sd">    ----------</span>
<span class="sd">    prep_delay : float, optional</span>
<span class="sd">        Delay used in the source in this network. Default is 5 [ns].</span>
<span class="sd">    qchannel_delay : float, optional</span>
<span class="sd">        Delay of quantum channel. Default is 100 [ns].</span>
<span class="sd">    num_mem_positions : int</span>
<span class="sd">        Number of memory positions on both nodes in the network. Default is 3.</span>

<span class="sd">    Returns</span>
<span class="sd">    -------</span>
<span class="sd">    :class:`~netsquid.components.component.Component`</span>
<span class="sd">        A network component with nodes and channels as subcomponents.</span>

<span class="sd">    Notes</span>
<span class="sd">    -----</span>
<span class="sd">        This network is also used by the matching integration test.</span>

<span class="sd">    &quot;&quot;&quot;</span>
    <span class="c1"># Setup nodes:</span>
    <span class="n">network</span> <span class="o">=</span> <span class="n">Network</span><span class="p">(</span><span class="s2">&quot;Entangle_nodes&quot;</span><span class="p">)</span>
    <span class="n">node_a</span><span class="p">,</span> <span class="n">node_b</span> <span class="o">=</span> <span class="n">network</span><span class="o">.</span><span class="n">add_nodes</span><span class="p">([</span><span class="s2">&quot;node_A&quot;</span><span class="p">,</span> <span class="s2">&quot;node_B&quot;</span><span class="p">])</span>
    <span class="n">node_a</span><span class="o">.</span><span class="n">add_subcomponent</span><span class="p">(</span><span class="n">QuantumProcessor</span><span class="p">(</span>
        <span class="s2">&quot;QuantumMemoryATest&quot;</span><span class="p">,</span> <span class="n">num_mem_positions</span><span class="p">,</span> <span class="n">fallback_to_nonphysical</span><span class="o">=</span><span class="kc">True</span><span class="p">))</span>
    <span class="n">node_b</span><span class="o">.</span><span class="n">add_subcomponent</span><span class="p">(</span><span class="n">QuantumProcessor</span><span class="p">(</span>
        <span class="s2">&quot;QuantumMemoryBTest&quot;</span><span class="p">,</span> <span class="n">num_mem_positions</span><span class="p">,</span> <span class="n">fallback_to_nonphysical</span><span class="o">=</span><span class="kc">True</span><span class="p">))</span>
    <span class="n">node_a</span><span class="o">.</span><span class="n">add_subcomponent</span><span class="p">(</span>
        <span class="n">QSource</span><span class="p">(</span><span class="s2">&quot;QSourceTest&quot;</span><span class="p">,</span> <span class="n">state_sampler</span><span class="o">=</span><span class="n">StateSampler</span><span class="p">([</span><span class="n">ks</span><span class="o">.</span><span class="n">b00</span><span class="p">]),</span>
                <span class="n">num_ports</span><span class="o">=</span><span class="mi">2</span><span class="p">,</span> <span class="n">status</span><span class="o">=</span><span class="n">SourceStatus</span><span class="o">.</span><span class="n">EXTERNAL</span><span class="p">,</span>
                <span class="n">models</span><span class="o">=</span><span class="p">{</span><span class="s2">&quot;emission_delay_model&quot;</span><span class="p">:</span> <span class="n">FixedDelayModel</span><span class="p">(</span><span class="n">delay</span><span class="o">=</span><span class="n">prep_delay</span><span class="p">)}))</span>
    <span class="c1"># Create and connect quantum channel:</span>
    <span class="n">qchannel</span> <span class="o">=</span> <span class="n">QuantumChannel</span><span class="p">(</span><span class="s2">&quot;QuantumChannelTest&quot;</span><span class="p">,</span> <span class="n">delay</span><span class="o">=</span><span class="n">qchannel_delay</span><span class="p">)</span>
    <span class="n">port_name_a</span><span class="p">,</span> <span class="n">port_name_b</span> <span class="o">=</span> <span class="n">network</span><span class="o">.</span><span class="n">add_connection</span><span class="p">(</span>
        <span class="n">node_a</span><span class="p">,</span> <span class="n">node_b</span><span class="p">,</span> <span class="n">channel_to</span><span class="o">=</span><span class="n">qchannel</span><span class="p">,</span> <span class="n">label</span><span class="o">=</span><span class="s2">&quot;quantum&quot;</span><span class="p">)</span>
    <span class="c1"># Setup Alice ports:</span>
    <span class="n">node_a</span><span class="o">.</span><span class="n">subcomponents</span><span class="p">[</span><span class="s2">&quot;QSourceTest&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">ports</span><span class="p">[</span><span class="s2">&quot;qout0&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">forward_output</span><span class="p">(</span>
        <span class="n">node_a</span><span class="o">.</span><span class="n">ports</span><span class="p">[</span><span class="n">port_name_a</span><span class="p">])</span>
    <span class="n">node_a</span><span class="o">.</span><span class="n">subcomponents</span><span class="p">[</span><span class="s2">&quot;QSourceTest&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">ports</span><span class="p">[</span><span class="s2">&quot;qout1&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">connect</span><span class="p">(</span>
        <span class="n">node_a</span><span class="o">.</span><span class="n">qmemory</span><span class="o">.</span><span class="n">ports</span><span class="p">[</span><span class="s2">&quot;qin0&quot;</span><span class="p">])</span>
    <span class="c1"># Setup Bob ports:</span>
    <span class="n">node_b</span><span class="o">.</span><span class="n">ports</span><span class="p">[</span><span class="n">port_name_b</span><span class="p">]</span><span class="o">.</span><span class="n">forward_input</span><span class="p">(</span><span class="n">node_b</span><span class="o">.</span><span class="n">qmemory</span><span class="o">.</span><span class="n">ports</span><span class="p">[</span><span class="s2">&quot;qin0&quot;</span><span class="p">])</span>
    <span class="k">return</span> <span class="n">network</span>
</pre></div>
</div>
<p>If parts of the code above are a bit unclear, it may help to read <a class="reference external" href="https://docs.netsquid.org/latest-release/tutorial.components.html#quantum-teleportation-using-components">this part of the tutorial</a>.</p>
<p>The protocol that runs on both nodes A and B will be an <a class="reference internal" href="#netsquid.examples.entanglenodes.EntangleNodes" title="netsquid.examples.entanglenodes.EntangleNodes"><code class="xref py py-class docutils literal notranslate"><span class="pre">EntangleNodes</span></code></a> protocol:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">EntangleNodes</span><span class="p">(</span><span class="n">NodeProtocol</span><span class="p">):</span>
    <span class="s2">&quot;&quot;&quot;Cooperate with another node to generate shared entanglement.</span>

<span class="s2">... &lt;remaining code omitted&gt;</span>
</pre></div>
</div>
<p>The protocol will begin generating an entangled pair when a trigger event occurs,
and will backlog successive trigger calls so that a new pair will begin to be generated once the first pair is ready.
This can be seen in its <cite>run()</cite> method below where the event expression that starts a new round is yielded on:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">run</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
    <span class="k">while</span> <span class="kc">True</span><span class="p">:</span>
        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">start_expression</span> <span class="ow">is</span> <span class="ow">not</span> <span class="kc">None</span><span class="p">:</span>
            <span class="k">yield</span> <span class="bp">self</span><span class="o">.</span><span class="n">start_expression</span>
        <span class="k">elif</span> <span class="bp">self</span><span class="o">.</span><span class="n">_is_source</span> <span class="ow">and</span> <span class="bp">self</span><span class="o">.</span><span class="n">entangled_pairs</span> <span class="o">&gt;=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_num_pairs</span><span class="p">:</span>
            <span class="c1"># If no start expression specified then limit generation to one round</span>
            <span class="k">break</span>
        <span class="k">for</span> <span class="n">mem_pos</span> <span class="ow">in</span> <span class="bp">self</span><span class="o">.</span><span class="n">_mem_positions</span><span class="p">[::</span><span class="o">-</span><span class="mi">1</span><span class="p">]:</span>
            <span class="c1"># Iterate in reverse so that input_mem_pos is handled last</span>
            <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">_is_source</span><span class="p">:</span>
                <span class="bp">self</span><span class="o">.</span><span class="n">node</span><span class="o">.</span><span class="n">subcomponents</span><span class="p">[</span><span class="bp">self</span><span class="o">.</span><span class="n">_qsource_name</span><span class="p">]</span><span class="o">.</span><span class="n">trigger</span><span class="p">()</span>
            <span class="k">yield</span> <span class="bp">self</span><span class="o">.</span><span class="n">await_port_input</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">_qmem_input_port</span><span class="p">)</span>
            <span class="k">if</span> <span class="n">mem_pos</span> <span class="o">!=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_input_mem_pos</span><span class="p">:</span>
                <span class="bp">self</span><span class="o">.</span><span class="n">node</span><span class="o">.</span><span class="n">qmemory</span><span class="o">.</span><span class="n">execute_instruction</span><span class="p">(</span>
                    <span class="n">INSTR_SWAP</span><span class="p">,</span> <span class="p">[</span><span class="bp">self</span><span class="o">.</span><span class="n">_input_mem_pos</span><span class="p">,</span> <span class="n">mem_pos</span><span class="p">])</span>
                <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">node</span><span class="o">.</span><span class="n">qmemory</span><span class="o">.</span><span class="n">busy</span><span class="p">:</span>
            ...
            <span class="bp">self</span><span class="o">.</span><span class="n">entangled_pairs</span> <span class="o">+=</span> <span class="mi">1</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">send_signal</span><span class="p">(</span><span class="n">Signals</span><span class="o">.</span><span class="n">SUCCESS</span><span class="p">,</span> <span class="n">mem_pos</span><span class="p">)</span>
</pre></div>
</div>
<p>The following script runs an example simulation with a single round of entanglement generation
(i.e. initialising the <a class="reference internal" href="#netsquid.examples.entanglenodes.EntangleNodes" title="netsquid.examples.entanglenodes.EntangleNodes"><code class="xref py py-class docutils literal notranslate"><span class="pre">EntangleNodes</span></code></a> protocol without a <cite>start_expression</cite>):</p>
...
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="s2">&quot;This example module is located at: &quot;</span>
<span class="gp">... </span>      <span class="s2">&quot;</span><span class="si">{}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">ns</span><span class="o">.</span><span class="n">examples</span><span class="o">.</span><span class="n">entanglenodes</span><span class="o">.</span><span class="vm">__file__</span><span class="p">))</span>
<span class="go">This example module is located at: .../netsquid/examples/entanglenodes.py</span>
<span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">netsquid.examples.entanglenodes</span> <span class="kn">import</span> <span class="n">example_network_setup</span><span class="p">,</span> <span class="n">EntangleNodes</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">network</span> <span class="o">=</span> <span class="n">example_network_setup</span><span class="p">()</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">protocol_a</span> <span class="o">=</span> <span class="n">EntangleNodes</span><span class="p">(</span><span class="n">node</span><span class="o">=</span><span class="n">network</span><span class="o">.</span><span class="n">subcomponents</span><span class="p">[</span><span class="s2">&quot;node_A&quot;</span><span class="p">],</span> <span class="n">role</span><span class="o">=</span><span class="s2">&quot;source&quot;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">protocol_b</span> <span class="o">=</span> <span class="n">EntangleNodes</span><span class="p">(</span><span class="n">node</span><span class="o">=</span><span class="n">network</span><span class="o">.</span><span class="n">subcomponents</span><span class="p">[</span><span class="s2">&quot;node_B&quot;</span><span class="p">],</span> <span class="n">role</span><span class="o">=</span><span class="s2">&quot;receiver&quot;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">protocol_a</span><span class="o">.</span><span class="n">start</span><span class="p">()</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">protocol_b</span><span class="o">.</span><span class="n">start</span><span class="p">()</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">ns</span><span class="o">.</span><span class="n">sim_run</span><span class="p">()</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">q1</span><span class="p">,</span> <span class="o">=</span> <span class="n">network</span><span class="o">.</span><span class="n">subcomponents</span><span class="p">[</span><span class="s2">&quot;node_A&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">qmemory</span><span class="o">.</span><span class="n">peek</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">q2</span><span class="p">,</span> <span class="o">=</span> <span class="n">network</span><span class="o">.</span><span class="n">subcomponents</span><span class="p">[</span><span class="s2">&quot;node_B&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">qmemory</span><span class="o">.</span><span class="n">peek</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Fidelity of generated entanglement: </span><span class="si">{}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span>
<span class="gp">... </span>      <span class="n">ns</span><span class="o">.</span><span class="n">qubits</span><span class="o">.</span><span class="n">fidelity</span><span class="p">([</span><span class="n">q1</span><span class="p">,</span> <span class="n">q2</span><span class="p">],</span> <span class="n">ns</span><span class="o">.</span><span class="n">b00</span><span class="p">)))</span>
<span class="go">Fidelity of generated entanglement: 0.99999...</span>
</pre></div>
</div>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.examples.entanglenodes.</span></span><span class="sig-name descname"><span class="pre">EntangleNodes</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">node</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">role</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">start_expression</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">input_mem_pos</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">num_pairs</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">1</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes" title="Link to this definition"></a></dt>
...
<p>Cooperate with another node to generate shared entanglement.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>node</strong> (<a class="reference internal" href="../api_nodes/netsquid.nodes.node.html#netsquid.nodes.node.Node" title="netsquid.nodes.node.Node"><code class="xref py py-class docutils literal notranslate"><span class="pre">Node</span></code></a>) – Node to run this protocol on.</p></li>
<li><p><strong>role</strong> (<em>“source” or “receiver”</em>) – Whether this protocol should act as a source or a receiver. Both are needed.</p></li>
<li><p><strong>start_expression</strong> (<a class="reference internal" href="../pydynaa.html#pydynaa.core.EventExpression" title="pydynaa.core.EventExpression"><code class="xref py py-class docutils literal notranslate"><span class="pre">EventExpression</span></code></a> or None, optional) – Event Expression to wait for before starting entanglement round.</p></li>
<li><p><strong>input_mem_pos</strong> (<em>int, optional</em>) – Index of quantum memory position to expect incoming qubits on. Default is 0.</p></li>
<li><p><strong>num_pairs</strong> (<em>int, optional</em>) – Number of entanglement pairs to create per round. If more than one, the extra qubits
will be stored on available memory positions.</p></li>
<li><p><strong>name</strong> (<em>str or None, optional</em>) – Name of protocol. If None a default name is set.</p></li>
</ul>
</dd>
</dl>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.start">
<span class="sig-name descname"><span class="pre">start</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.start" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.stop">
<span class="sig-name descname"><span class="pre">stop</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.stop" title="Link to this definition"></a></dt>
<dd><p>Stop the protocol as well as any running sub-protocols.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.run">
<span class="sig-name descname"><span class="pre">run</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.run" title="Link to this definition"></a></dt>
...
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.is_connected">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">is_connected</span></span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.is_connected" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.add_signal">
<span class="sig-name descname"><span class="pre">add_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">event_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.add_signal" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.add_subprotocol">
<span class="sig-name descname"><span class="pre">add_subprotocol</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">subprotocol</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.add_subprotocol" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.await_mempos_busy_toggle">
<span class="sig-name descname"><span class="pre">await_mempos_busy_toggle</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">QuantumMemory</span> <span class="pre">qmemory</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">list</span> <span class="pre">positions</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.await_mempos_busy_toggle" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.await_mempos_in_use_toggle">
<span class="sig-name descname"><span class="pre">await_mempos_in_use_toggle</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">QuantumMemory</span> <span class="pre">qmemory</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">list</span> <span class="pre">positions</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.await_mempos_in_use_toggle" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.await_port_input">
<span class="sig-name descname"><span class="pre">await_port_input</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">port</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.await_port_input" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.await_port_output">
<span class="sig-name descname"><span class="pre">await_port_output</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">port</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.await_port_output" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.await_program">
<span class="sig-name descname"><span class="pre">await_program</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">type</span> <span class="pre">cls</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">processor</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">await_done=True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">await_fail=False</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.await_program" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.await_signal">
<span class="sig-name descname"><span class="pre">await_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">Protocol</span> <span class="pre">sender</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">signal_label=Signals.FINISHED</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.await_signal" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.await_timer">
<span class="sig-name descname"><span class="pre">await_timer</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">duration=0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">end_time=0</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.await_timer" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.can_signal_to">
<span class="sig-name descname"><span class="pre">can_signal_to</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">protocol</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.can_signal_to" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.check_assigned">
<em class="property"><span class="pre">static</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">check_assigned</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">inputs</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">input_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.check_assigned" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.get_signal_by_event">
<span class="sig-name descname"><span class="pre">get_signal_by_event</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">event</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">receiver</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.get_signal_by_event" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.get_signal_result">
<span class="sig-name descname"><span class="pre">get_signal_result</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">receiver</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.get_signal_result" title="Link to this definition"></a></dt>
...
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.is_running">
<span class="sig-name descname"><span class="pre">is_running</span></span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.is_running" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.max_nodes">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">max_nodes</span></span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.max_nodes" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.name">
<span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.name" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.node">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">node</span></span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.node" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.nodes">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">nodes</span></span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.nodes" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.remove">
<span class="sig-name descname"><span class="pre">remove</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.remove" title="Link to this definition"></a></dt>
<dd><p>Removes the entity from the simulation.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.reset" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.send_signal">
<span class="sig-name descname"><span class="pre">send_signal</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">signal_label</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">result</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.send_signal" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.signals">
<span class="sig-name descname"><span class="pre">signals</span></span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.signals" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.specify_node">
<span class="sig-name descname"><span class="pre">specify_node</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.specify_node" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.start_subprotocols">
<span class="sig-name descname"><span class="pre">start_subprotocols</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.start_subprotocols" title="Link to this definition"></a></dt>
<dd><p>Start all the sub-protocols in parallel.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.subprotocols">
<span class="sig-name descname"><span class="pre">subprotocols</span></span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.subprotocols" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.EntangleNodes.uid">
<span class="sig-name descname"><span class="pre">uid</span></span><a class="headerlink" href="#netsquid.examples.entanglenodes.EntangleNodes.uid" title="Link to this definition"></a></dt>
...
<dt class="sig sig-object py" id="netsquid.examples.entanglenodes.example_network_setup">
<span class="sig-prename descclassname"><span class="pre">netsquid.examples.entanglenodes.</span></span><span class="sig-name descname"><span class="pre">example_network_setup</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">prep_delay</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">5</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">qchannel_delay</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">100</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">num_mem_positions</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">3</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.examples.entanglenodes.example_network_setup" title="Link to this definition"></a></dt>
<dd><p>Create an example network for use with the entangling nodes protocol.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>prep_delay</strong> (<em>float, optional</em>) – Delay used in the source in this network. Default is 5 [ns].</p></li>
<li><p><strong>qchannel_delay</strong> (<em>float, optional</em>) – Delay of quantum channel. Default is 100 [ns].</p></li>
<li><p><strong>num_mem_positions</strong> (<em>int</em>) – Number of memory positions on both nodes in the network. Default is 3.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>A network component with nodes and channels as subcomponents.</p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="../api_components/netsquid.components.component.html#netsquid.components.component.Component" title="netsquid.components.component.Component"><code class="xref py py-class docutils literal notranslate"><span class="pre">Component</span></code></a></p>
</dd>
</dl>
<p class="rubric">Notes</p>
<p>This network is also used by the matching integration test.</p>
</dd></dl>
        ...
        <a href="netsquid.examples.teleportation.html" class="btn btn-neutral float-left" title="netsquid.examples.teleportation" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.examples.purify.html" class="btn btn-neutral float-right" title="netsquid.examples.purify" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
