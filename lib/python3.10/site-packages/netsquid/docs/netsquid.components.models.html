...
<head>
  ...
  <title>netsquid.components.models &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.components.models.model" href="api_models/netsquid.components.models.model.html" />
    <link rel="prev" title="netsquid.components.ccoding" href="api_components/netsquid.components.ccoding.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">netsquid.components.models</a><ul>
...
<li class="toctree-l1"><a class="reference internal" href="CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.components.models</li>
      <li class="wy-breadcrumbs-aside">
            <a href="_sources/netsquid.components.models.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="api_components/netsquid.components.ccoding.html" class="btn btn-neutral float-left" title="netsquid.components.ccoding" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="api_models/netsquid.components.models.model.html" class="btn btn-neutral float-right" title="netsquid.components.models.model" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="netsquid-components-models">
<h1>netsquid.components.models<a class="headerlink" href="#netsquid-components-models" title="Link to this heading"></a></h1>
<p>In NetSquid <em>models</em> are used describe the physical behaviour of components in a functional way.
Models derive from a <a class="reference internal" href="api_models/netsquid.components.models.model.html#netsquid.components.models.model.Model" title="netsquid.components.models.model.Model"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Model</span></code></a> base class.</p>
<p>Schematic overview of <a class="reference internal" href="api_models/netsquid.components.models.model.html#netsquid.components.models.model.Model" title="netsquid.components.models.model.Model"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Model</span></code></a> and its subclasses:</p>
<img alt="_images/models3.png" class="align-center" src="_images/models3.png" />
<p>Model can be added to other models with the <code class="docutils literal notranslate"><span class="pre">__add__</span></code> operator (+), or multiplied by integers.
...
Currently the supported Models for concatenation are <a class="reference internal" href="api_models/netsquid.components.models.errormodels.html#netsquid.components.models.errormodels.ErrorModel" title="netsquid.components.models.errormodels.ErrorModel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">ErrorModel</span></code></a>,
<a class="reference internal" href="api_models/netsquid.components.models.cerrormodels.html#netsquid.components.models.cerrormodels.ClassicalErrorModel" title="netsquid.components.models.cerrormodels.ClassicalErrorModel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">ClassicalErrorModel</span></code></a>,
<a class="reference internal" href="api_models/netsquid.components.models.qerrormodels.html#netsquid.components.models.qerrormodels.QuantumErrorModel" title="netsquid.components.models.qerrormodels.QuantumErrorModel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">QuantumErrorModel</span></code></a> and
<a class="reference internal" href="api_models/netsquid.components.models.delaymodels.html#netsquid.components.models.delaymodels.DelayModel" title="netsquid.components.models.delaymodels.DelayModel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">DelayModel</span></code></a>.</p>
<p>For example adding a <a class="reference internal" href="api_models/netsquid.components.models.qerrormodels.html#netsquid.components.models.qerrormodels.DephaseNoiseModel" title="netsquid.components.models.qerrormodels.DephaseNoiseModel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">DephaseNoiseModel</span></code></a> with
a <a class="reference internal" href="api_models/netsquid.components.models.qerrormodels.html#netsquid.components.models.qerrormodels.DepolarNoiseModel" title="netsquid.components.models.qerrormodels.DepolarNoiseModel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">DepolarNoiseModel</span></code></a> results in a
<a class="reference internal" href="api_models/netsquid.components.models.qerrormodels.html#netsquid.components.models.qerrormodels.QuantumErrorModel" title="netsquid.components.models.qerrormodels.QuantumErrorModel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">QuantumErrorModel</span></code></a>.
Adding a <a class="reference internal" href="api_models/netsquid.components.models.delaymodels.html#netsquid.components.models.delaymodels.DelayModel" title="netsquid.components.models.delaymodels.DelayModel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">DelayModel</span></code></a> with a
<a class="reference internal" href="api_models/netsquid.components.models.qerrormodels.html#netsquid.components.models.qerrormodels.QuantumErrorModel" title="netsquid.components.models.qerrormodels.QuantumErrorModel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">QuantumErrorModel</span></code></a> is not possible, as the first common superclass
(<code class="xref py py-obj docutils literal notranslate"><span class="pre">Model</span></code>), does not support concatenating models.</p>
<p>To make your own Models concatenable overwrite <code class="xref py py-meth docutils literal notranslate"><span class="pre">concatenation_class()</span></code> and
return the class your model should concatenate to (can be the same class, or a subclass)</p>
<p>Note that in general <span class="math notranslate nohighlight">\(n*(model1 + model2) \neq n*model1 + n*model2\)</span> unless <code class="docutils literal notranslate"><span class="pre">model1</span></code> and <code class="docutils literal notranslate"><span class="pre">model2</span></code> are commutative.</p>
<div class="toctree-wrapper compound">
<p class="caption" role="heading"><span class="caption-text">Modules</span></p>
<ul>
<li class="toctree-l1"><a class="reference internal" href="api_models/netsquid.components.models.model.html">netsquid.components.models.model</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.model.html#netsquid.components.models.model.Model"><code class="docutils literal notranslate"><span class="pre">Model</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.model.html#netsquid.components.models.model.ModelCompositionException"><code class="docutils literal notranslate"><span class="pre">ModelCompositionException</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_models/netsquid.components.models.delaymodels.html">netsquid.components.models.delaymodels</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.delaymodels.html#netsquid.components.models.delaymodels.DelayModel"><code class="docutils literal notranslate"><span class="pre">DelayModel</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.delaymodels.html#netsquid.components.models.delaymodels.FixedDelayModel"><code class="docutils literal notranslate"><span class="pre">FixedDelayModel</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.delaymodels.html#netsquid.components.models.delaymodels.GaussianDelayModel"><code class="docutils literal notranslate"><span class="pre">GaussianDelayModel</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.delaymodels.html#netsquid.components.models.delaymodels.FibreDelayModel"><code class="docutils literal notranslate"><span class="pre">FibreDelayModel</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_models/netsquid.components.models.errormodels.html">netsquid.components.models.errormodels</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.errormodels.html#netsquid.components.models.errormodels.ErrorModel"><code class="docutils literal notranslate"><span class="pre">ErrorModel</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_models/netsquid.components.models.qerrormodels.html">netsquid.componentsmodels.qerrormodels</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.qerrormodels.html#netsquid.components.models.qerrormodels.QuantumErrorModel"><code class="docutils literal notranslate"><span class="pre">QuantumErrorModel</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.qerrormodels.html#netsquid.components.models.qerrormodels.DepolarNoiseModel"><code class="docutils literal notranslate"><span class="pre">DepolarNoiseModel</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.qerrormodels.html#netsquid.components.models.qerrormodels.DephaseNoiseModel"><code class="docutils literal notranslate"><span class="pre">DephaseNoiseModel</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.qerrormodels.html#netsquid.components.models.qerrormodels.T1T2NoiseModel"><code class="docutils literal notranslate"><span class="pre">T1T2NoiseModel</span></code></a></li>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.qerrormodels.html#netsquid.components.models.qerrormodels.FibreLossModel"><code class="docutils literal notranslate"><span class="pre">FibreLossModel</span></code></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api_models/netsquid.components.models.cerrormodels.html">netsquid.components.models.cerrormodels</a><ul>
<li class="toctree-l2"><a class="reference internal" href="api_models/netsquid.components.models.cerrormodels.html#netsquid.components.models.cerrormodels.ClassicalErrorModel"><code class="docutils literal notranslate"><span class="pre">ClassicalErrorModel</span></code></a></li>
</ul>
</li>
</ul>
</div>
        ...
        <a href="api_components/netsquid.components.ccoding.html" class="btn btn-neutral float-left" title="netsquid.components.ccoding" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="api_models/netsquid.components.models.model.html" class="btn btn-neutral float-right" title="netsquid.components.models.model" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
