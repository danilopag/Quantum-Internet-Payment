...
<head>
  ...
  <title>netsquid.components.ccoding &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.components.models" href="../netsquid.components.models.html" />
    <link rel="prev" title="netsquid.components.switch" href="netsquid.components.switch.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.components.ccoding</a></li>
</ul>
</li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.components.ccoding</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_components/netsquid.components.ccoding.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.components.switch.html" class="btn btn-neutral float-left" title="netsquid.components.switch" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="../netsquid.components.models.html" class="btn btn-neutral float-right" title="netsquid.components.models" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.components.ccoding">
<span id="netsquid-components-ccoding"></span><h1>netsquid.components.ccoding<a class="headerlink" href="#module-netsquid.components.ccoding" title="Link to this heading"></a></h1>
<p>Defines coding utilities for classical components.</p>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.components.ccoding.CodedItem">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.components.ccoding.</span></span><span class="sig-name descname"><span class="pre">CodedItem</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">item</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.ccoding.CodedItem" title="Link to this definition"></a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">object</span></code></p>
<p>An general object used for converting object types to a specific encoding.</p>
<p>Subclass this abstract base class to define different encodings.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>item</strong> (<em>Any</em>) – Item to encode in a coded object.</p>
</dd>
</dl>
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.ccoding.CodedItem.has_encoding">
<em class="property"><span class="pre">abstract</span><span class="w"> </span><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">has_encoding</span></span><a class="headerlink" href="#netsquid.components.ccoding.CodedItem.has_encoding" title="Link to this definition"></a></dt>
<dd><p>whether item has an encoding.</p>
<dl class="field-list simple">
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.ccoding.CodedItem.object_types">
<em class="property"><span class="pre">abstract</span><span class="w"> </span><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">object_types</span></span><a class="headerlink" href="#netsquid.components.ccoding.CodedItem.object_types" title="Link to this definition"></a></dt>
<dd><p>Object types that can be converted.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.ccoding.CodedItem.encoding_type">
<em class="property"><span class="pre">abstract</span><span class="w"> </span><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">encoding_type</span></span><a class="headerlink" href="#netsquid.components.ccoding.CodedItem.encoding_type" title="Link to this definition"></a></dt>
<dd><p>Object type of encoded item.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.ccoding.CodedItem.encoded_item">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">encoded_item</span></span><a class="headerlink" href="#netsquid.components.ccoding.CodedItem.encoded_item" title="Link to this definition"></a></dt>
<dd><p>Encoded object.</p>
</dd></dl>

<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.ccoding.CodedItem.item">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">item</span></span><a class="headerlink" href="#netsquid.components.ccoding.CodedItem.item" title="Link to this definition"></a></dt>
<dd><p>Original (decoded) item.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.ccoding.CodedItem.encode">
<em class="property"><span class="pre">abstract</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">encode</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.ccoding.CodedItem.encode" title="Link to this definition"></a></dt>
<dd><p>Encode the item.</p>
<dl class="field-list simple">
<dt class="field-odd">Returns<span class="colon">:</span></dt>
<dd class="field-odd"><p>Encoded item.</p>
</dd>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.ccoding.CodedItem.decode">
<em class="property"><span class="pre">abstract</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">decode</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">encoded_item</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.ccoding.CodedItem.decode" title="Link to this definition"></a></dt>
<dd><p>Decode an encoded item.</p>
<p>If no encoding is available, the original item
is simply returned.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>encoded_item</strong> (<em>Any or None, optional</em>) – Item to decode. If <code class="docutils literal notranslate"><span class="pre">None</span></code>,
the held encoded item is decoded.</p>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>Decoded item.</p>
</dd>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.ccoding.CodedItem.apply_loss_model">
<em class="property"><span class="pre">abstract</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">apply_loss_model</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">loss_model</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">delta_time</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">0.0</span></span></em>, <em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">properties</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.ccoding.CodedItem.apply_loss_model" title="Link to this definition"></a></dt>
<dd><p>Apply a loss model to the encoded item.</p>
<p>Modifies the encoded item in-place.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>loss_model</strong> (<a class="reference internal" href="../api_models/netsquid.components.models.cerrormodels.html#netsquid.components.models.cerrormodels.ClassicalErrorModel" title="netsquid.components.models.cerrormodels.ClassicalErrorModel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">ClassicalErrorModel</span></code></a>) – Loss model to apply to encoded item.</p></li>
<li><p><strong>delta_time</strong> (<em>float, optional</em>) – Time item has spent on channel [ns].</p></li>
<li><p><strong>**properties</strong> – Component properties to pass to model.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>Whether the whole encoded item is lost.</p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p>bool</p>
</dd>
...
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.components.ccoding.ClassicalCodingFactory">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.components.ccoding.</span></span><span class="sig-name descname"><span class="pre">ClassicalCodingFactory</span></span><a class="headerlink" href="#netsquid.components.ccoding.ClassicalCodingFactory" title="Link to this definition"></a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">object</span></code></p>
<p>Interface for a class that converts data into a classical code object.</p>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.ccoding.ClassicalCodingFactory.create_coded_item">
<em class="property"><span class="pre">classmethod</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">create_coded_item</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">item</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.ccoding.ClassicalCodingFactory.create_coded_item" title="Link to this definition"></a></dt>
<dd><p>Creates the classical coded object for given data.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>item</strong> (<em>Any</em>) – The item we want to encapsulate into a classical coded item.</p>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>An instantiation of the classical coded item appropriate for the provided item.</p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="#netsquid.components.ccoding.CodedItem" title="netsquid.components.ccoding.CodedItem"><code class="xref py py-obj docutils literal notranslate"><span class="pre">CodedItem</span></code></a></p>
</dd>
</dl>
</dd></dl>
        ...
        <a href="netsquid.components.switch.html" class="btn btn-neutral float-left" title="netsquid.components.switch" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="../netsquid.components.models.html" class="btn btn-neutral float-right" title="netsquid.components.models" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
