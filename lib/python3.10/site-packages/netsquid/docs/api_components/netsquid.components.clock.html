...
<head>
  ...
  <title>netsquid.components.clock &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.components.qsource" href="netsquid.components.qsource.html" />
    <link rel="prev" title="netsquid.components.qprocessor" href="netsquid.components.qprocessor.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.components.clock</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.components.clock</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_components/netsquid.components.clock.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.components.qprocessor.html" class="btn btn-neutral float-left" title="netsquid.components.qprocessor" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.components.qsource.html" class="btn btn-neutral float-right" title="netsquid.components.qsource" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.components.clock">
<span id="netsquid-components-clock"></span><h1>netsquid.components.clock<a class="headerlink" href="#module-netsquid.components.clock" title="Link to this heading"></a></h1>
<p>This module specifies a clock component, which can be used by other components to keep time.</p>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.components.clock.</span></span><span class="sig-name descname"><span class="pre">Clock</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">frequency</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">models</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">start_delay</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">max_ticks</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">-1</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">properties</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.clock.Clock" title="Link to this definition"></a></dt>
<dd><p>Bases: <a class="reference internal" href="netsquid.components.component.html#netsquid.components.component.Component" title="netsquid.components.component.Component"><code class="xref py py-class docutils literal notranslate"><span class="pre">Component</span></code></a></p>
<p>A component that can be used by other components to keep time.</p>
<p>The clock works by sending messages to its “cout”  port at specific time intervals.
A timing model can be used to model timing inaccuracies.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>name</strong> (<em>str</em>) – Name of the clock component.</p></li>
<li><p><strong>frequency</strong> (<em>float</em>) – Frequency at which ticks are generated when not providing a <code class="docutils literal notranslate"><span class="pre">timing_model</span></code> [Hz].</p></li>
...
<li><p><strong>start_delay</strong> (<em>float, optional</em>) – Time after which the clock will output its first tick [ns].</p></li>
<li><p><strong>max_ticks</strong> (<em>int, optional</em>) – Maximum number of ticks before the clock stops automatically. Default is -1, which represents infinity.</p></li>
<li><p><strong>properties</strong> (<em>dict or None, optional</em>) – Extra properties associated with this component.
If a <code class="docutils literal notranslate"><span class="pre">start_delay</span></code> is in <code class="docutils literal notranslate"><span class="pre">properties</span></code> this will overwrite the <code class="docutils literal notranslate"><span class="pre">start_delay</span></code> given to the constructor as
argument.</p></li>
</ul>
</dd>
<dt class="field-even">Properties<span class="colon">:</span></dt>
<dd class="field-even"><p><strong>start_delay</strong> (<em>float</em>) – Time (&gt;= 0) after which the clock will output its first tick [ns].</p>
</dd>
<dt class="field-odd">Ports<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>cout</strong> – Output port for announcing a tick.</p>
</dd>
<dt class="field-even">Models<span class="colon">:</span></dt>
<dd class="field-even"><p><strong>timing_model</strong> (obj:<cite>~netsquid.components.models.delaymodels.DelayModel</cite> or None, optional) – Model used to calculate the time between ticks. When no model is given a fixed delay
of 1 / <code class="docutils literal notranslate"><span class="pre">frequency</span></code> is used.</p>
</dd>
</dl>
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.frequency">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">frequency</span></span><a class="headerlink" href="#netsquid.components.clock.Clock.frequency" title="Link to this definition"></a></dt>
<dd><p>(mean) frequency at which the clock ticks [Hz].</p>
<dl class="field-list simple">
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.is_running">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">is_running</span></span><a class="headerlink" href="#netsquid.components.clock.Clock.is_running" title="Link to this definition"></a></dt>
<dd><p>Whether this Clock is currently running.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.num_ticks">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">num_ticks</span></span><a class="headerlink" href="#netsquid.components.clock.Clock.num_ticks" title="Link to this definition"></a></dt>
<dd><p>Number of ticks this clock has produced.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.get_period">
<span class="sig-name descname"><span class="pre">get_period</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.clock.Clock.get_period" title="Link to this definition"></a></dt>
<dd><p>Returns a period based on the clock’s timing model [ns].</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.start">
<span class="sig-name descname"><span class="pre">start</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.clock.Clock.start" title="Link to this definition"></a></dt>
<dd><p>Start clock and kick off the timer which will start after a <code class="docutils literal notranslate"><span class="pre">start_delay</span></code> as specified in this clock’s properties.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.stop">
<span class="sig-name descname"><span class="pre">stop</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.clock.Clock.stop" title="Link to this definition"></a></dt>
<dd><p>Stop clock and dismiss handler.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.reset">
<span class="sig-name descname"><span class="pre">reset</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.clock.Clock.reset" title="Link to this definition"></a></dt>
<dd><p>Reset this clock and all its ports to its initial conditions (including the status at construction).</p>
<p>Also stops the clock if it is running.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.add_ports">
<span class="sig-name descname"><span class="pre">add_ports</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">names</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.clock.Clock.add_ports" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.add_property">
<span class="sig-name descname"><span class="pre">add_property</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">mutable</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_constraints</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.clock.Clock.add_property" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.has_subcomponent">
<span class="sig-name descname"><span class="pre">has_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.clock.Clock.has_subcomponent" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.has_supercomponent">
<span class="sig-name descname"><span class="pre">has_supercomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">component</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.clock.Clock.has_supercomponent" title="Link to this definition"></a></dt>
<dd><p>Whether argument is a supercomponent of this component at any level.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.models">
<span class="sig-name descname"><span class="pre">models</span></span><a class="headerlink" href="#netsquid.components.clock.Clock.models" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.name">
<span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#netsquid.components.clock.Clock.name" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.ports">
<span class="sig-name descname"><span class="pre">ports</span></span><a class="headerlink" href="#netsquid.components.clock.Clock.ports" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.properties">
<span class="sig-name descname"><span class="pre">properties</span></span><a class="headerlink" href="#netsquid.components.clock.Clock.properties" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.rem_subcomponent">
<span class="sig-name descname"><span class="pre">rem_subcomponent</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.clock.Clock.rem_subcomponent" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.remove">
<span class="sig-name descname"><span class="pre">remove</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.clock.Clock.remove" title="Link to this definition"></a></dt>
<dd><p>Removes the entity from the simulation.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.specify_model">
<span class="sig-name descname"><span class="pre">specify_model</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">model_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.clock.Clock.specify_model" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.subcomponents">
<span class="sig-name descname"><span class="pre">subcomponents</span></span><a class="headerlink" href="#netsquid.components.clock.Clock.subcomponents" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.supercomponent">
<span class="sig-name descname"><span class="pre">supercomponent</span></span><a class="headerlink" href="#netsquid.components.clock.Clock.supercomponent" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.components.clock.Clock.uid">
<span class="sig-name descname"><span class="pre">uid</span></span><a class="headerlink" href="#netsquid.components.clock.Clock.uid" title="Link to this definition"></a></dt>
...
<dd class="field-odd"><p>int</p>
        ...
        <a href="netsquid.components.qprocessor.html" class="btn btn-neutral float-left" title="netsquid.components.qprocessor" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.components.qsource.html" class="btn btn-neutral float-right" title="netsquid.components.qsource" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
