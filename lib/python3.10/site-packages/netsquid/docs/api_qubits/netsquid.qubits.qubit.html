...
<head>
  ...
  <title>netsquid.qubits.qubit &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.qubits.qstate" href="netsquid.qubits.qstate.html" />
    <link rel="prev" title="netsquid.qubits.state_sampler" href="netsquid.qubits.state_sampler.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.qubits.qubit</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.qubits.qubit</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_qubits/netsquid.qubits.qubit.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.qubits.state_sampler.html" class="btn btn-neutral float-left" title="netsquid.qubits.state_sampler" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.qubits.qstate.html" class="btn btn-neutral float-right" title="netsquid.qubits.qstate" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.qubits.qubit">
<span id="netsquid-qubits-qubit"></span><h1>netsquid.qubits.qubit<a class="headerlink" href="#module-netsquid.qubits.qubit" title="Link to this heading"></a></h1>
<p>The <a class="reference internal" href="#netsquid.qubits.qubit.Qubit" title="netsquid.qubits.qubit.Qubit"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Qubit</span></code></a> class that holds a single qubit
...
the user.</p>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.qubits.qubit.Qubit">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.qubits.qubit.</span></span><span class="sig-name descname"><span class="pre">Qubit</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.qubits.qubit.Qubit" title="Link to this definition"></a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">object</span></code></p>
<p>Class that holds a single qubit within a (shared) quantum state.</p>
<p>The <cite>Qubit</cite> instance is intended to stay persistent while the quantum state changes.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>name</strong> (<em>str</em>) – Name for the qubit – should be unique within the shared QState.</p>
</dd>
</dl>
<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.qubits.qubit.Qubit.is_number_state">
<span class="sig-name descname"><span class="pre">is_number_state</span></span><a class="headerlink" href="#netsquid.qubits.qubit.Qubit.is_number_state" title="Link to this definition"></a></dt>
<dd><p>Whether qubit represents a number state e.g. the presence or absence
of a photon. If so, a quantum channel may not actually discard the
qubit when it is lost, but rather amplitude dampen it.</p>
<dl class="field-list simple">
...
<p>Because a <em>number state</em> qubit is intended to be amplitude dampened by a
channel loss model, this setting will not work with stabilizer quantum
states.</p>
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.qubits.qubit.Qubit.name">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#netsquid.qubits.qubit.Qubit.name" title="Link to this definition"></a></dt>
<dd><p>Name for the qubit.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.qubits.qubit.Qubit.qstate">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">qstate</span></span><a class="headerlink" href="#netsquid.qubits.qubit.Qubit.qstate" title="Link to this definition"></a></dt>
<dd><p>(shared) quantum state of this qubit.</p>
<p>Can be <code class="docutils literal notranslate"><span class="pre">None</span></code> if the qubit has not yet been initialized or it has been
discarded.</p>
<p>For most uses cases it is better to make use of the <a class="reference internal" href="netsquid.qubits.qubitapi.html#module-netsquid.qubits.qubitapi" title="netsquid.qubits.qubitapi"><code class="xref py py-mod docutils literal notranslate"><span class="pre">qubitapi</span></code></a> module
rather than accessing the quantum state directly.</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="netsquid.qubits.qstate.html#netsquid.qubits.qstate.QState" title="netsquid.qubits.qstate.QState"><code class="xref py py-obj docutils literal notranslate"><span class="pre">QState</span></code></a></p>
</dd>
</dl>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.qubits.qubit.Qubit.combine">
<span class="sig-name descname"><span class="pre">combine</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">other_qubit</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.qubits.qubit.Qubit.combine" title="Link to this definition"></a></dt>
<dd><p>Join the quantum state of this qubit with that of another.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>other_qubit</strong> (<a class="reference internal" href="#netsquid.qubits.qubit.Qubit" title="netsquid.qubits.qubit.Qubit"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Qubit</span></code></a>) – The other qubit to combine with.</p>
</dd>
<dt class="field-even">Raises<span class="colon">:</span></dt>
<dd class="field-even"><p><strong>RuntimeError</strong> – If either qubit is not holding a quantum state.</p>
</dd>
</dl>
<p class="rubric">Notes</p>
<p>If the qubits already share the same quantum states then nothing
is done.</p>
</dd></dl>
        ...
        <a href="netsquid.qubits.state_sampler.html" class="btn btn-neutral float-left" title="netsquid.qubits.state_sampler" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.qubits.qstate.html" class="btn btn-neutral float-right" title="netsquid.qubits.qstate" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
