...
<head>
  ...
  <title>netsquid.qubits.gslcutil &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.qubits.opmath" href="netsquid.qubits.opmath.html" />
    <link rel="prev" title="netsquid.qubits.sparseutil" href="netsquid.qubits.sparseutil.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.qubits.gslcutil</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.qubits.gslcutil</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_qubits/netsquid.qubits.gslcutil.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.qubits.sparseutil.html" class="btn btn-neutral float-left" title="netsquid.qubits.sparseutil" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.qubits.opmath.html" class="btn btn-neutral float-right" title="netsquid.qubits.opmath" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.qubits.gslcutil">
<span id="netsquid-qubits-gslcutil"></span><h1>netsquid.qubits.gslcutil<a class="headerlink" href="#module-netsquid.qubits.gslcutil" title="Link to this heading"></a></h1>
<p>Utility functions for manipulating graph states.</p>
<dl class="py function">
<dt class="sig sig-object py" id="netsquid.qubits.gslcutil.gslc2ket">
<span class="sig-prename descclassname"><span class="pre">netsquid.qubits.gslcutil.</span></span><span class="sig-name descname"><span class="pre">gslc2ket</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">gslc</span></span></em><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><span class="pre">ndarray</span></span></span><a class="headerlink" href="#netsquid.qubits.gslcutil.gslc2ket" title="Link to this definition"></a></dt>
<dd><p>Create a ket vector for this GSLC representation.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>gslc</strong> (<code class="xref py py-class docutils literal notranslate"><span class="pre">GSLCRepr</span></code>) – Graph State to convert.</p>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>Ket state (column vector) of the graph state.</p>
</dd>
...
<dl class="py function">
<dt class="sig sig-object py" id="netsquid.qubits.gslcutil.gslc2dm">
<span class="sig-prename descclassname"><span class="pre">netsquid.qubits.gslcutil.</span></span><span class="sig-name descname"><span class="pre">gslc2dm</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">gslc</span></span></em><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><span class="pre">ndarray</span></span></span><a class="headerlink" href="#netsquid.qubits.gslcutil.gslc2dm" title="Link to this definition"></a></dt>
<dd><p>Density matrix of this qubit representation.</p>
...
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>DM state (density matrix) of the graph state.</p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p><code class="xref py py-class docutils literal notranslate"><span class="pre">numpy.array</span></code></p>
</dd>
        ...
        <a href="netsquid.qubits.sparseutil.html" class="btn btn-neutral float-left" title="netsquid.qubits.sparseutil" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.qubits.opmath.html" class="btn btn-neutral float-right" title="netsquid.qubits.opmath" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
