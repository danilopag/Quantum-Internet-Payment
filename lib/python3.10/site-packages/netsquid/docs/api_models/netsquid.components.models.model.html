...
<head>
  ...
  <title>netsquid.components.models.model &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.components.models.delaymodels" href="netsquid.components.models.delaymodels.html" />
    <link rel="prev" title="netsquid.components.models" href="../netsquid.components.models.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.components.models.model</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.components.models.model</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_models/netsquid.components.models.model.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="../netsquid.components.models.html" class="btn btn-neutral float-left" title="netsquid.components.models" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.components.models.delaymodels.html" class="btn btn-neutral float-right" title="netsquid.components.models.delaymodels" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.components.models.model">
<span id="netsquid-components-models-model"></span><h1>netsquid.components.models.model<a class="headerlink" href="#module-netsquid.components.models.model" title="Link to this heading"></a></h1>
<p>The model interface (abstract base class) defined in this module allows
users to specify custom functionality for the elements of the simulation.</p>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.components.models.model.Model">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.components.models.model.</span></span><span class="sig-name descname"><span class="pre">Model</span></span><a class="headerlink" href="#netsquid.components.models.model.Model" title="Link to this definition"></a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">object</span></code></p>
<p>Interface to apply different functionalities (models) to the simulation
components.</p>
<p>Models can be used by any object as long as the parameters needed by the
model are provided. The parameters needed by the models are divided in two types:
properties and required_properties.</p>
<p class="rubric">Notes</p>
<p>Each model has a minimum of requirements (parameters that need to be
defined) in order for the model to be executed. The <em>model properties</em> are
independent of the object that is calling the model and hence, some
default values have already been set. The <em>required properties</em> depend on
...
an object is instantiated or as attributes.</p>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.model.Model.concatenation_class">
<em class="property"><span class="pre">classmethod</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">concatenation_class</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.model.Model.concatenation_class" title="Link to this definition"></a></dt>
<dd><p>Type of the object that is returned when concatenating this model.</p>
<p>To be overwritten for classes that can be concatenated/combined.</p>
<dl class="field-list simple">
<dt class="field-odd">Returns<span class="colon">:</span></dt>
<dd class="field-odd"><p>The class that should be used when concatenating two Models that are an instance of this class</p>
</dd>
<dt class="field-even">Return type<span class="colon">:</span></dt>
<dd class="field-even"><p>subclass of <cite>~netsquid.components.models.Model</cite> or None</p>
</dd>
</dl>
</dd></dl>

<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.models.model.Model.properties">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">properties</span></span><a class="headerlink" href="#netsquid.components.models.model.Model.properties" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.model.Model.add_property">
<span class="sig-name descname"><span class="pre">add_property</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">mutable</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_constraints</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.model.Model.add_property" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.models.model.Model.required_properties">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">required_properties</span></span><a class="headerlink" href="#netsquid.components.models.model.Model.required_properties" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.model.Model.validate">
<span class="sig-name descname"><span class="pre">validate</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">properties</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.model.Model.validate" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.model.Model.compute_model">
<em class="property"><span class="pre">abstract</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">compute_model</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="o"><span class="pre">*</span></span><span class="n"><span class="pre">args</span></span></em>, <em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">kwargs</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.model.Model.compute_model" title="Link to this definition"></a></dt>
<dd><p>Execute the model based on the given parameters and model properties.</p>
<p>This is the method called when the object is used as a callable function.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>*args</strong> – Any dynamic variable passed to the model.</p></li>
<li><p><strong>**kwargs</strong> – These are the <a class="reference internal" href="#netsquid.components.models.model.Model.required_properties" title="netsquid.components.models.model.Model.required_properties"><code class="xref py py-attr docutils literal notranslate"><span class="pre">required_properties</span></code></a>
needed by the model.</p></li>
</ul>
</dd>
</dl>
<p class="rubric">Notes</p>
<p>For error models it executes the method “error_operation”.
For delay models it executes the method “generate_delay”.</p>
</dd></dl>

<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.models.model.Model.is_concatenated">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">is_concatenated</span></span><a class="headerlink" href="#netsquid.components.models.model.Model.is_concatenated" title="Link to this definition"></a></dt>
...
<dt class="sig sig-object py" id="netsquid.components.models.model.ModelCompositionException">
<em class="property"><span class="pre">exception</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.components.models.model.</span></span><span class="sig-name descname"><span class="pre">ModelCompositionException</span></span><a class="headerlink" href="#netsquid.components.models.model.ModelCompositionException" title="Link to this definition"></a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">Exception</span></code></p>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.model.ModelCompositionException.with_traceback">
<span class="sig-name descname"><span class="pre">with_traceback</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.model.ModelCompositionException.with_traceback" title="Link to this definition"></a></dt>
...
set self.__traceback__ to tb and return self.</p>
        ...
        <a href="../netsquid.components.models.html" class="btn btn-neutral float-left" title="netsquid.components.models" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.components.models.delaymodels.html" class="btn btn-neutral float-right" title="netsquid.components.models.delaymodels" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
