...
<head>
  ...
  <title>netsquid.components.models.cerrormodels &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.nodes" href="../netsquid.nodes.html" />
    <link rel="prev" title="netsquid.componentsmodels.qerrormodels" href="netsquid.components.models.qerrormodels.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.components.models.cerrormodels</a></li>
</ul>
</li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.components.models.cerrormodels</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_models/netsquid.components.models.cerrormodels.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.components.models.qerrormodels.html" class="btn btn-neutral float-left" title="netsquid.componentsmodels.qerrormodels" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="../netsquid.nodes.html" class="btn btn-neutral float-right" title="netsquid.nodes" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.components.models.cerrormodels">
<span id="netsquid-components-models-cerrormodels"></span><h1>netsquid.components.models.cerrormodels<a class="headerlink" href="#module-netsquid.components.models.cerrormodels" title="Link to this heading"></a></h1>
<p>The classical error model interface (abstract base class) defined in this module
allows users to specify custom error (e.g. noise or loss) functionality for components.</p>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.components.models.cerrormodels.ClassicalErrorModel">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.components.models.cerrormodels.</span></span><span class="sig-name descname"><span class="pre">ClassicalErrorModel</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">kwargs</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.cerrormodels.ClassicalErrorModel" title="Link to this definition"></a></dt>
...
<p>Interface for a callable object that applies errors to classical items.</p>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.cerrormodels.ClassicalErrorModel.error_operation">
<span class="sig-name descname"><span class="pre">error_operation</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">items</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">delta_time</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">0</span></span></em>, <em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">kwargs</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.cerrormodels.ClassicalErrorModel.error_operation" title="Link to this definition"></a></dt>
<dd><p>Error operation to apply to items (to be overridden).</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>items</strong> (list of any except <a class="reference internal" href="../api_qubits/netsquid.qubits.qubit.html#netsquid.qubits.qubit.Qubit" title="netsquid.qubits.qubit.Qubit"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Qubit</span></code></a>) – Items to apply error to.</p></li>
<li><p><strong>delta_time</strong> (<em>float, optional</em>) – Time items have spent on a component [ns].</p></li>
</ul>
</dd>
</dl>
</dd></dl>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.cerrormodels.ClassicalErrorModel.compute_model">
<span class="sig-name descname"><span class="pre">compute_model</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">items</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">delta_time</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">0</span></span></em>, <em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">kwargs</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.cerrormodels.ClassicalErrorModel.compute_model" title="Link to this definition"></a></dt>
...
<dd class="field-even"><p><strong>TypeError</strong> – If a <a class="reference internal" href="../api_qubits/netsquid.qubits.qubit.html#netsquid.qubits.qubit.Qubit" title="netsquid.qubits.qubit.Qubit"><code class="xref py py-obj docutils literal notranslate"><span class="pre">Qubit</span></code></a> is passed in the list of items.</p>
</dd>
</dl>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.cerrormodels.ClassicalErrorModel.concatenation_class">
<em class="property"><span class="pre">classmethod</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">concatenation_class</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.cerrormodels.ClassicalErrorModel.concatenation_class" title="Link to this definition"></a></dt>
<dd><p>Type of the object that is returned when concatenating this model</p>
<dl class="field-list simple">
<dt class="field-odd">Returns<span class="colon">:</span></dt>
<dd class="field-odd"><p>Concatenating two (subclasses of) ClassicalErrorModel results in a ClassicalErrorModel</p>
</dd>
<dt class="field-even">Return type<span class="colon">:</span></dt>
<dd class="field-even"><p><a class="reference internal" href="#netsquid.components.models.cerrormodels.ClassicalErrorModel" title="netsquid.components.models.cerrormodels.ClassicalErrorModel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">ClassicalErrorModel</span></code></a></p>
</dd>
</dl>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.cerrormodels.ClassicalErrorModel.add_property">
<span class="sig-name descname"><span class="pre">add_property</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">mutable</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_constraints</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.cerrormodels.ClassicalErrorModel.add_property" title="Link to this definition"></a></dt>
...
<dt class="sig sig-object py" id="netsquid.components.models.cerrormodels.ClassicalErrorModel.is_concatenated">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">is_concatenated</span></span><a class="headerlink" href="#netsquid.components.models.cerrormodels.ClassicalErrorModel.is_concatenated" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.models.cerrormodels.ClassicalErrorModel.properties">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">properties</span></span><a class="headerlink" href="#netsquid.components.models.cerrormodels.ClassicalErrorModel.properties" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.models.cerrormodels.ClassicalErrorModel.required_properties">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">required_properties</span></span><a class="headerlink" href="#netsquid.components.models.cerrormodels.ClassicalErrorModel.required_properties" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.cerrormodels.ClassicalErrorModel.validate">
<span class="sig-name descname"><span class="pre">validate</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">properties</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.cerrormodels.ClassicalErrorModel.validate" title="Link to this definition"></a></dt>
...
<dd class="field-odd"><p>bool</p>
        ...
        <a href="netsquid.components.models.qerrormodels.html" class="btn btn-neutral float-left" title="netsquid.componentsmodels.qerrormodels" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="../netsquid.nodes.html" class="btn btn-neutral float-right" title="netsquid.nodes" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
