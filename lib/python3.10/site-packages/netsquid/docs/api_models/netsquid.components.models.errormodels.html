...
<head>
  ...
  <title>netsquid.components.models.errormodels &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.componentsmodels.qerrormodels" href="netsquid.components.models.qerrormodels.html" />
    <link rel="prev" title="netsquid.components.models.delaymodels" href="netsquid.components.models.delaymodels.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.components.models.errormodels</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.components.models.errormodels</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_models/netsquid.components.models.errormodels.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.components.models.delaymodels.html" class="btn btn-neutral float-left" title="netsquid.components.models.delaymodels" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.components.models.qerrormodels.html" class="btn btn-neutral float-right" title="netsquid.componentsmodels.qerrormodels" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.components.models.errormodels">
<span id="netsquid-components-models-errormodels"></span><h1>netsquid.components.models.errormodels<a class="headerlink" href="#module-netsquid.components.models.errormodels" title="Link to this heading"></a></h1>
<p>The error model interface (abstract base class) defined in this module allows
users to specify custom error functionality for the elements of the simulation.</p>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.components.models.errormodels.ErrorModel">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.components.models.errormodels.</span></span><span class="sig-name descname"><span class="pre">ErrorModel</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">kwargs</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.errormodels.ErrorModel" title="Link to this definition"></a></dt>
...
<p>Interface for a callable object that applies errors to items.</p>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.errormodels.ErrorModel.error_operation">
<span class="sig-name descname"><span class="pre">error_operation</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">items</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">delta_time</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">0</span></span></em>, <em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">kwargs</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.errormodels.ErrorModel.error_operation" title="Link to this definition"></a></dt>
<dd><p>Error operation to apply to items (to be overridden).</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>items</strong> (<em>list of any</em>) – Items to apply error to.</p></li>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.errormodels.ErrorModel.compute_model">
<span class="sig-name descname"><span class="pre">compute_model</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">items</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">delta_time</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">0</span></span></em>, <em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">kwargs</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.errormodels.ErrorModel.compute_model" title="Link to this definition"></a></dt>
...
<dd class="field-even"><p><strong>TypeError</strong> – If the parameter <code class="docutils literal notranslate"><span class="pre">items</span></code> is not a list.</p>
</dd>
</dl>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.errormodels.ErrorModel.concatenation_class">
<em class="property"><span class="pre">classmethod</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">concatenation_class</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.errormodels.ErrorModel.concatenation_class" title="Link to this definition"></a></dt>
<dd><p>Type of the object that is returned when concatenating this model</p>
<dl class="field-list simple">
<dt class="field-odd">Returns<span class="colon">:</span></dt>
<dd class="field-odd"><p>Concatenating two (subclasses of) ErrorModel results in a ErrorModel</p>
</dd>
<dt class="field-even">Return type<span class="colon">:</span></dt>
<dd class="field-even"><p><a class="reference internal" href="#netsquid.components.models.errormodels.ErrorModel" title="netsquid.components.models.errormodels.ErrorModel"><code class="xref py py-obj docutils literal notranslate"><span class="pre">ErrorModel</span></code></a></p>
</dd>
</dl>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.errormodels.ErrorModel.add_property">
<span class="sig-name descname"><span class="pre">add_property</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">name</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">mutable</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_type</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">value_constraints</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.errormodels.ErrorModel.add_property" title="Link to this definition"></a></dt>
...
<dt class="sig sig-object py" id="netsquid.components.models.errormodels.ErrorModel.is_concatenated">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">is_concatenated</span></span><a class="headerlink" href="#netsquid.components.models.errormodels.ErrorModel.is_concatenated" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.models.errormodels.ErrorModel.properties">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">properties</span></span><a class="headerlink" href="#netsquid.components.models.errormodels.ErrorModel.properties" title="Link to this definition"></a></dt>
...
<dl class="py property">
<dt class="sig sig-object py" id="netsquid.components.models.errormodels.ErrorModel.required_properties">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">required_properties</span></span><a class="headerlink" href="#netsquid.components.models.errormodels.ErrorModel.required_properties" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.components.models.errormodels.ErrorModel.validate">
<span class="sig-name descname"><span class="pre">validate</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">properties</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.components.models.errormodels.ErrorModel.validate" title="Link to this definition"></a></dt>
...
<dd class="field-odd"><p>bool</p>
        ...
        <a href="netsquid.components.models.delaymodels.html" class="btn btn-neutral float-left" title="netsquid.components.models.delaymodels" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.components.models.qerrormodels.html" class="btn btn-neutral float-right" title="netsquid.componentsmodels.qerrormodels" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
