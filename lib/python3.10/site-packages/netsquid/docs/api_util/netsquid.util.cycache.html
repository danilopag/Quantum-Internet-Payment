...
<head>
  ...
  <title>netsquid.util.cycache &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.util.cymath" href="netsquid.util.cymath.html" />
    <link rel="prev" title="netsquid.util.datacollector" href="netsquid.util.datacollector.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.util.cycache</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.util.cycache</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_util/netsquid.util.cycache.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.util.datacollector.html" class="btn btn-neutral float-left" title="netsquid.util.datacollector" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.util.cymath.html" class="btn btn-neutral float-right" title="netsquid.util.cymath" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.util.cycache">
<span id="netsquid-util-cycache"></span><h1>netsquid.util.cycache<a class="headerlink" href="#module-netsquid.util.cycache" title="Link to this heading"></a></h1>
<p>Cythonized least recently used (LRU) cache.</p>
<dl class="py class">
<dt class="sig sig-object py" id="netsquid.util.cycache.LruCache">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">netsquid.util.cycache.</span></span><span class="sig-name descname"><span class="pre">LruCache</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">int</span> <span class="pre">size_limit=1000000</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.cycache.LruCache" title="Link to this definition"></a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">object</span></code></p>
<p>Least recently used (LRU) bounded cache using a get/setitem interface.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>size_limit</strong> (<em>int, optional</em>) – Maximum number of entries/keys to be stored in the cache. Should be
greater than 0.</p>
</dd>
<dt class="field-even">Raises<span class="colon">:</span></dt>
<dd class="field-even"><p><strong>KeyError</strong> – If a key is requested that is not in LruCache.</p>
</dd>
</dl>
<p class="rubric">Notes</p>
<p>We set the default size limit at 1e6, that is approximately 50Mb for
sparse matrices.</p>
<p>Based on answer from <a class="reference external" href="https://stackoverflow.com/a/8334739">Stackoverflow</a>.</p>
<dl class="py method">
<dt class="sig sig-object py" id="netsquid.util.cycache.LruCache.clear">
<span class="sig-name descname"><span class="pre">clear</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.cycache.LruCache.clear" title="Link to this definition"></a></dt>
<dd><p>Clear the cache, similarly to a dictionary.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.util.cycache.LruCache.get">
<span class="sig-name descname"><span class="pre">get</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">key</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">default</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.cycache.LruCache.get" title="Link to this definition"></a></dt>
<dd><p>Return the value belonging to key.</p>
<p>Returns a default value when the key is not in the cache.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="netsquid.util.cycache.LruCache.keys">
<span class="sig-name descname"><span class="pre">keys</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.cycache.LruCache.keys" title="Link to this definition"></a></dt>
<dd><p>Returns a key-iterator just like dict.keys().</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="netsquid.util.cycache.LruCache.size_limit">
<span class="sig-name descname"><span class="pre">size_limit</span></span><a class="headerlink" href="#netsquid.util.cycache.LruCache.size_limit" title="Link to this definition"></a></dt>
<dd><p>‘int’</p>
<dl class="field-list simple">
<dt class="field-odd">Type<span class="colon">:</span></dt>
<dd class="field-odd"><p>size_limit</p>
</dd>
</dl>
</dd></dl>
        ...
        <a href="netsquid.util.datacollector.html" class="btn btn-neutral float-left" title="netsquid.util.datacollector" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.util.cymath.html" class="btn btn-neutral float-right" title="netsquid.util.cymath" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
