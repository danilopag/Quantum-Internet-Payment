...
<head>
  ...
  <title>netsquid.util.cymath &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.util.constrainedmap" href="netsquid.util.constrainedmap.html" />
    <link rel="prev" title="netsquid.util.cycache" href="netsquid.util.cycache.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.util.cymath</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.util.cymath</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_util/netsquid.util.cymath.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.util.cycache.html" class="btn btn-neutral float-left" title="netsquid.util.cycache" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.util.constrainedmap.html" class="btn btn-neutral float-right" title="netsquid.util.constrainedmap" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.util.cymath">
<span id="netsquid-util-cymath"></span><h1>netsquid.util.cymath<a class="headerlink" href="#module-netsquid.util.cymath" title="Link to this heading"></a></h1>
<p>Cython versions of math utility functions.</p>
<dl class="py function">
<dt class="sig sig-object py" id="netsquid.util.cymath.correct_global_phase">
<span class="sig-prename descclassname"><span class="pre">netsquid.util.cymath.</span></span><span class="sig-name descname"><span class="pre">correct_global_phase</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">ndarray</span> <span class="pre">vector</span></span></em><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><span class="pre">ndarray</span></span></span><a class="headerlink" href="#netsquid.util.cymath.correct_global_phase" title="Link to this definition"></a></dt>
<dd><p>Set a consistent global phase for a ket vector.</p>
<p>Ensures first non-zero element is positive and real</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>vector</strong> (<code class="xref py py-obj docutils literal notranslate"><span class="pre">matrix</span></code>) – Ket vector.</p>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>Ket vector with corrected global phase.</p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p><code class="xref py py-obj docutils literal notranslate"><span class="pre">matrix</span></code></p>
</dd>
</dl>
</dd></dl>

<dl class="py function">
<dt class="sig sig-object py" id="netsquid.util.cymath.isclose">
<span class="sig-prename descclassname"><span class="pre">netsquid.util.cymath.</span></span><span class="sig-name descname"><span class="pre">isclose</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">a</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">b</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">rel_tol=1e-09</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">double</span> <span class="pre">abs_tol=0.0</span></span></em><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><span class="pre">bool</span></span></span><a class="headerlink" href="#netsquid.util.cymath.isclose" title="Link to this definition"></a></dt>
<dd></dd></dl>
        ...
        <a href="netsquid.util.cycache.html" class="btn btn-neutral float-left" title="netsquid.util.cycache" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.util.constrainedmap.html" class="btn btn-neutral float-right" title="netsquid.util.constrainedmap" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
