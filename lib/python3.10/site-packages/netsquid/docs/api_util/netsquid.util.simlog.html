...
<head>
  ...
  <title>netsquid.util.simlog &mdash; NetSquid 1.1.7 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="netsquid.util.simstats" href="netsquid.util.simstats.html" />
    <link rel="prev" title="netsquid.util.simtools" href="netsquid.util.simtools.html" /> 
</head>
...
<li class="toctree-l3 current"><a class="current reference internal" href="#">netsquid.util.simlog</a></li>
<li class="toctree-l3"><a class="reference internal" href="netsquid.util.simstats.html">netsquid.util.simstats</a></li>
<li class="toctree-l3"><a class="reference internal" href="netsquid.util.datacollector.html">netsquid.util.datacollector</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../CHANGELOG.html">Changelog</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">netsquid.util.simlog</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../_sources/api_util/netsquid.util.simlog.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul><div class="rst-breadcrumbs-buttons" role="navigation" aria-label="Sequential page navigation">
        <a href="netsquid.util.simtools.html" class="btn btn-neutral float-left" title="netsquid.util.simtools" accesskey="p"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.util.simstats.html" class="btn btn-neutral float-right" title="netsquid.util.simstats" accesskey="n">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
  </div>
  <hr/>
</div>
  ...
  <section id="module-netsquid.util.simlog">
<span id="netsquid-util-simlog"></span><h1>netsquid.util.simlog<a class="headerlink" href="#module-netsquid.util.simlog" title="Link to this heading"></a></h1>
<p>Simulation logging utilities.</p>
<p>NetSquid makes use of <a class="reference external" href="https://docs.python.org/3/library/logging.html">logging</a>, i.e. the logging facility for Python,
...
<a class="reference internal" href="#netsquid.util.simlog.get_loggers" title="netsquid.util.simlog.get_loggers"><code class="xref py py-meth docutils literal notranslate"><span class="pre">get_loggers()</span></code></a>. Note that the default logger level is set globally to WARNING, i.e. the level
of the logger <cite>netsquid</cite> is set to this value. The logger level of the (child) loggers may be configured locally by
selecting the logger from the dictionary and adjusting its level with the <code class="xref py py-meth docutils literal notranslate"><span class="pre">logging.Logger.setLevel()</span></code> method. To
reset the logger level of a child logger, such that it takes on the value of the parent logger again, simply set the
logger level to NOTSET.</p>
<dl class="py data">
<dt class="sig sig-object py" id="netsquid.util.simlog.logger">
<span class="sig-prename descclassname"><span class="pre">netsquid.util.simlog.</span></span><span class="sig-name descname"><span class="pre">logger</span></span><em class="property"><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">&lt;Logger</span> <span class="pre">netsquid</span> <span class="pre">(WARNING)&gt;</span></em><a class="headerlink" href="#netsquid.util.simlog.logger" title="Link to this definition"></a></dt>
<dd><p>root logger for netsquid package.</p>
...
<dt class="sig sig-object py" id="netsquid.util.simlog.get_loggers">
<span class="sig-prename descclassname"><span class="pre">netsquid.util.simlog.</span></span><span class="sig-name descname"><span class="pre">get_loggers</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.simlog.get_loggers" title="Link to this definition"></a></dt>
<dd><p>Retrieve all module loggers for the netsquid package.</p>
<dl class="field-list simple">
<dt class="field-odd">Returns<span class="colon">:</span></dt>
<dd class="field-odd"><p>All registered loggers for the netsquid package.</p>
</dd>
...
<p>Obtain all registered loggers for the NetSquid package.</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">netsquid.util</span> <span class="kn">import</span> <span class="n">simlog</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">simlog</span><span class="o">.</span><span class="n">get_loggers</span><span class="p">()</span>  
<span class="go">{&#39;netsquid.util.simtools&#39;: &lt;Logger netsquid.util.simtools (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.util&#39;: &lt;Logger netsquid.util (WARNING)&gt;,</span>
<span class="go">&#39;netsquid&#39;: &lt;Logger netsquid (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.qubits.qrepr&#39;: &lt;Logger netsquid.qubits.qrepr (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.qubits&#39;: &lt;Logger netsquid.qubits (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.qubits.qstate&#39;: &lt;Logger netsquid.qubits.qstate (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.qubits.stabtools&#39;: &lt;Logger netsquid.qubits.stabtools (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.qubits.kettools&#39;: &lt;Logger netsquid.qubits.kettools (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.qubits.dmtools&#39;: &lt;Logger netsquid.qubits.dmtools (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.qubits.sparsedmtools&#39;: &lt;Logger netsquid.qubits.sparsedmtools (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.components.component&#39;: &lt;Logger netsquid.components.component (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.components&#39;: &lt;Logger netsquid.components (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.components.channel&#39;: &lt;Logger netsquid.components.channel (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.components.cchannel&#39;: &lt;Logger netsquid.components.cchannel (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.components.qprocessor&#39;: &lt;Logger netsquid.components.qprocessor (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.nodes.node&#39;: &lt;Logger netsquid.nodes.node (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.nodes&#39;: &lt;Logger netsquid.nodes (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.protocols.protocol&#39;: &lt;Logger netsquid.protocols.protocol (WARNING)&gt;,</span>
<span class="go">&#39;netsquid.protocols&#39;: &lt;Logger netsquid.protocols (WARNING)&gt;}</span>
</pre></div>
</div>
<p>Configure the logger level of a subpackage or a particular module.</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">netsquid.util</span> <span class="kn">import</span> <span class="n">simlog</span>
<span class="gp">&gt;&gt;&gt; </span><span class="kn">import</span> <span class="nn">logging</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">loggers</span> <span class="o">=</span> <span class="n">simlog</span><span class="o">.</span><span class="n">get_loggers</span><span class="p">()</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">loggers</span><span class="p">[</span><span class="s1">&#39;netsquid.qubits&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">setLevel</span><span class="p">(</span><span class="n">logging</span><span class="o">.</span><span class="n">DEBUG</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">loggers</span><span class="p">[</span><span class="s1">&#39;netsquid.qubits.qstate&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">setLevel</span><span class="p">(</span><span class="n">logging</span><span class="o">.</span><span class="n">INFO</span><span class="p">)</span>
</pre></div>
</div>
<p>Reset the logger level of a subpackage or a particular module.</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">netsquid.util</span> <span class="kn">import</span> <span class="n">simlog</span>
<span class="gp">&gt;&gt;&gt; </span><span class="kn">import</span> <span class="nn">logging</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">loggers</span> <span class="o">=</span> <span class="n">simlog</span><span class="o">.</span><span class="n">get_loggers</span><span class="p">()</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">loggers</span><span class="p">[</span><span class="s1">&#39;netsquid.qubits.qstate&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">setLevel</span><span class="p">(</span><span class="n">logging</span><span class="o">.</span><span class="n">NOTSET</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">loggers</span><span class="p">[</span><span class="s1">&#39;netsquid.qubits&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">setLevel</span><span class="p">(</span><span class="n">logging</span><span class="o">.</span><span class="n">NOTSET</span><span class="p">)</span>
</pre></div>
</div>
</dd></dl>

<dl class="py function">
<dt class="sig sig-object py" id="netsquid.util.simlog.warn_deprecated">
<span class="sig-prename descclassname"><span class="pre">netsquid.util.simlog.</span></span><span class="sig-name descname"><span class="pre">warn_deprecated</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">message</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">key</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">stacklevel</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">2</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.simlog.warn_deprecated" title="Link to this definition"></a></dt>
<dd><p>Warn that the called functionality is deprecated.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>message</strong> (<em>str</em>) – Warning message to print.</p></li>
<li><p><strong>key</strong> (<em>str or None, optional</em>) – Unique string for warning to ensure it is only printed once.</p></li>
<li><p><strong>stacklevel</strong> (<em>int, optional</em>) – Level in stack to show information such as filename and linenumber for.
If 1, current location is shown, if 2 location of the caller, etc.
This wrapper function is ignored (it is stacklevel 0).</p></li>
</ul>
</dd>
</dl>
</dd></dl>
...
<dl class="py function">
<dt class="sig sig-object py" id="netsquid.util.simlog.check_memory_usage">
<span class="sig-prename descclassname"><span class="pre">netsquid.util.simlog.</span></span><span class="sig-name descname"><span class="pre">check_memory_usage</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">max_memory_increase</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">filters</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">include_default_filters</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#netsquid.util.simlog.check_memory_usage" title="Link to this definition"></a></dt>
<dd><p>Context manager that checks NetSquid does not exceed a memory allocation limit for a code block.</p>
<p>Use with ‘with’:</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">netsquid.util</span> <span class="kn">import</span> <span class="n">simlog</span>
<span class="gp">&gt;&gt;&gt; </span><span class="k">with</span> <span class="n">simlog</span><span class="o">.</span><span class="n">check_memory_usage</span><span class="p">(</span><span class="mi">10000</span><span class="p">,</span> <span class="n">include_default_filters</span><span class="o">=</span><span class="kc">False</span><span class="p">):</span>
<span class="gp">... </span>    <span class="nb">print</span><span class="p">(</span><span class="mi">42</span><span class="p">)</span>
<span class="go">42</span>
<span class="gp">&gt;&gt;&gt; </span><span class="k">with</span> <span class="n">simlog</span><span class="o">.</span><span class="n">check_memory_usage</span><span class="p">(</span><span class="mi">100</span><span class="p">,</span> <span class="n">include_default_filters</span><span class="o">=</span><span class="kc">False</span><span class="p">):</span>
<span class="gp">... </span>    <span class="nb">print</span><span class="p">(</span><span class="mi">42</span><span class="p">)</span>
<span class="gt">Traceback (most recent call last):</span>
<span class="c">...</span>
<span class="gr">MemoryError</span>: <span class="n">More memory used (...) than expected/allowed (100 B)...</span>
</pre></div>
</div>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>max_memory_increase</strong> (<em>int</em>) – Maximum memory in number of bytes that NetSquid may allocate when running this code block [B].</p></li>
<li><p><strong>filters</strong> (list of <code class="xref py py-obj docutils literal notranslate"><span class="pre">tracemalloc:Filter</span></code> or None,  optional) – Filters on traces of memory blocks. A trace is ignored if no inclusive filters match it.
A trace is ignored if at least one exclusive filter matches it. (See the tracemalloc documentation at
<a class="reference external" href="https://docs.python.org/3.6/library/tracemalloc.html">https://docs.python.org/3.6/library/tracemalloc.html</a>)</p></li>
<li><p><strong>include_default_filters</strong> (<em>bool (default: True)</em>) – Whether the default NetSquid filters should be applied. The default filters are listed below.</p></li>
</ul>
</dd>
<dt class="field-even">Raises<span class="colon">:</span></dt>
<dd class="field-even"><p><strong>MemoryError</strong> – If the block allocated more memory than expected/allowed.</p>
</dd>
</dl>
<p class="rubric">Notes</p>
<p>Default filters:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">tracemalloc.Filter(True,</span> <span class="pre">&quot;*netsquid*&quot;)</span>&#160; <span class="pre">#</span> <span class="pre">only</span> <span class="pre">trace</span> <span class="pre">memory</span> <span class="pre">in</span> <span class="pre">netsquid</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">tracemalloc.Filter(False,</span> <span class="pre">&quot;*netsquid/util/datacollector*&quot;)</span>&#160; <span class="pre">#</span> <span class="pre">don't</span> <span class="pre">trace</span> <span class="pre">memory</span> <span class="pre">in</span> <span class="pre">data</span> <span class="pre">collector</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">tracemalloc.Filter(False,</span> <span class="pre">&quot;*/test*&quot;)</span>&#160; <span class="pre">#</span> <span class="pre">don't</span> <span class="pre">trace</span> <span class="pre">memory</span> <span class="pre">in</span> <span class="pre">tests</span></code></p></li>
</ul>
<p>A garbage collection is done before both memory snapshots.</p>
</dd></dl>
        ...
        <a href="netsquid.util.simtools.html" class="btn btn-neutral float-left" title="netsquid.util.simtools" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="netsquid.util.simstats.html" class="btn btn-neutral float-right" title="netsquid.util.simstats" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
